...
2. **Deterministic Span Substrate**: Fixed-capacity ring buffer (1,000 spans) with allocation-bounded contiguous slab invariants and microsecond-precision timing.
