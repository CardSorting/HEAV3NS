...
- Pinned benchmark contract:
  ...
  - **Pass Rate**: 100%
  - **Throughput Enforced**: $\ge 1,000\text{ frames/second}$ (latest host run: **$8506.11\text{ frames/second}$** across **566/566 components**)
  - **Turn Tick Latency SLA**: $< 1.0\text{ ms}$ (latest host run: **$0.12\text{ ms}$**)
  - **State Rewind Latency SLA**: $< 0.1\text{ ms p95}$ (latest host run: **$0.029\text{ ms p95}$**)
  - **Flappy Bird React Synthesis**: 12/12 files synthesized in memory, 8/8 assertions passing, verified at **$361.50\text{ ms}$**.
