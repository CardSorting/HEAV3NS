...
const AppLoadingState = ({ label = "Starting HEAV3NS…" }: { label?: string }) => (
	<div
		aria-busy="true"
		aria-live="polite"
		className="flex h-full w-full flex-col justify-between p-4 bg-background text-foreground select-none"
	>
		...
		<div className="flex flex-col gap-3 my-auto px-2">
			...
			<div className="h-20 w-full rounded-lg bg-muted/20 border border-border/30 animate-pulse" />
		</div>

		<div className="rounded-lg border border-border/40 bg-card/40 p-2.5 backdrop-blur-sm">
