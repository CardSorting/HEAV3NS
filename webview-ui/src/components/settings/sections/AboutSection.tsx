		...
		<div>
			...
			<Section>
				<div className="flex px-4 flex-col gap-2">
					<h2 className="text-lg font-semibold">HEAV3NS v{version}</h2>
					<p>
						A friendly AI companion for coding. HEAV3NS helps with edits, terminal commands, browser tasks, and more —
