...
import { FileDiagnostics, Metadata as Metadata1 } from "../dietcode/common";

export interface GetWorkspacePathsRequest {
  /**
   * The unique ID for the workspace/project.
   * This is currently optional in vscode. It is required in other environments where dietcode is running at
...
export interface OpenDietCodeSidebarPanelRequest {
}

export interface OpenDietCodeSidebarPanelResponse {
}
...
function createBaseOpenDietCodeSidebarPanelRequest(): OpenDietCodeSidebarPanelRequest {
  return {};
}

export const OpenDietCodeSidebarPanelRequest: MessageFns<OpenDietCodeSidebarPanelRequest> = {
  encode(_: OpenDietCodeSidebarPanelRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): OpenDietCodeSidebarPanelRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
    ...
    try {
      const end = length === undefined ? reader.len : reader.pos + length;
      const message = createBaseOpenDietCodeSidebarPanelRequest();
      while (reader.pos < end) {
        const tag = reader.uint32();
        switch (tag >>> 3) {
        }
  ...
  fromJSON(_: any): OpenDietCodeSidebarPanelRequest {
    return {};
  },

  toJSON(_: OpenDietCodeSidebarPanelRequest): unknown {
    const obj: any = {};
    return obj;
  },

  create<I extends Exact<DeepPartial<OpenDietCodeSidebarPanelRequest>, I>>(base?: I): OpenDietCodeSidebarPanelRequest {
    return OpenDietCodeSidebarPanelRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<OpenDietCodeSidebarPanelRequest>, I>>(_: I): OpenDietCodeSidebarPanelRequest {
    const message = createBaseOpenDietCodeSidebarPanelRequest();
    return message;
  },
};

function createBaseOpenDietCodeSidebarPanelResponse(): OpenDietCodeSidebarPanelResponse {
  return {};
}

export const OpenDietCodeSidebarPanelResponse: MessageFns<OpenDietCodeSidebarPanelResponse> = {
  encode(_: OpenDietCodeSidebarPanelResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): OpenDietCodeSidebarPanelResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
    ...
    try {
      const end = length === undefined ? reader.len : reader.pos + length;
      const message = createBaseOpenDietCodeSidebarPanelResponse();
      while (reader.pos < end) {
        const tag = reader.uint32();
        switch (tag >>> 3) {
        }
  ...
  fromJSON(_: any): OpenDietCodeSidebarPanelResponse {
    return {};
  },

  toJSON(_: OpenDietCodeSidebarPanelResponse): unknown {
    const obj: any = {};
    return obj;
  },

  create<I extends Exact<DeepPartial<OpenDietCodeSidebarPanelResponse>, I>>(
    base?: I,
  ): OpenDietCodeSidebarPanelResponse {
    return OpenDietCodeSidebarPanelResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<OpenDietCodeSidebarPanelResponse>, I>>(
    _: I,
  ): OpenDietCodeSidebarPanelResponse {
    const message = createBaseOpenDietCodeSidebarPanelResponse();
    return message;
...
export const WorkspaceServiceDefinition = {
  ...
  methods: {
    ...
    getWorkspacePaths: {
      ...
      requestType: GetWorkspacePathsRequest as typeof GetWorkspacePathsRequest,
      requestStream: false,
      responseType: GetWorkspacePathsResponse as typeof GetWorkspacePathsResponse,
    ...
    saveOpenDocumentIfDirty: {
      ...
      requestType: SaveOpenDocumentIfDirtyRequest as typeof SaveOpenDocumentIfDirtyRequest,
      requestStream: false,
      responseType: SaveOpenDocumentIfDirtyResponse as typeof SaveOpenDocumentIfDirtyResponse,
      responseStream: false,
      options: {},
    },
    ...
    getDiagnostics: {
      name: "getDiagnostics",
      requestType: GetDiagnosticsRequest as typeof GetDiagnosticsRequest,
      requestStream: false,
      responseType: GetDiagnosticsResponse as typeof GetDiagnosticsResponse,
      responseStream: false,
      options: {},
    },
    ...
    openProblemsPanel: {
      ...
      requestType: OpenProblemsPanelRequest as typeof OpenProblemsPanelRequest,
      requestStream: false,
      responseType: OpenProblemsPanelResponse as typeof OpenProblemsPanelResponse,
      responseStream: false,
      options: {},
    },
    ...
    openInFileExplorerPanel: {
      ...
      requestType: OpenInFileExplorerPanelRequest as typeof OpenInFileExplorerPanelRequest,
      requestStream: false,
      responseType: OpenInFileExplorerPanelResponse as typeof OpenInFileExplorerPanelResponse,
      responseStream: false,
      options: {},
    },
    /** Opens and focuses the DietCode sidebar panel in the host IDE. */
    openDietCodeSidebarPanel: {
      name: "openDietCodeSidebarPanel",
      requestType: OpenDietCodeSidebarPanelRequest as typeof OpenDietCodeSidebarPanelRequest,
      requestStream: false,
      responseType: OpenDietCodeSidebarPanelResponse as typeof OpenDietCodeSidebarPanelResponse,
      responseStream: false,
      options: {},
    },
    ...
    openTerminalPanel: {
      ...
      requestType: OpenTerminalRequest as typeof OpenTerminalRequest,
      requestStream: false,
      responseType: OpenTerminalResponse as typeof OpenTerminalResponse,
      responseStream: false,
      options: {},
    },
    ...
    executeCommandInTerminal: {
      ...
      requestType: ExecuteCommandInTerminalRequest as typeof ExecuteCommandInTerminalRequest,
      requestStream: false,
      responseType: ExecuteCommandInTerminalResponse as typeof ExecuteCommandInTerminalResponse,
      responseStream: false,
      options: {},
    },
    ...
    openFolder: {
      name: "openFolder",
      requestType: OpenFolderRequest as typeof OpenFolderRequest,
      requestStream: false,
      responseType: OpenFolderResponse as typeof OpenFolderResponse,
      responseStream: false,
      options: {},
    },
  },
...
export const WorkspaceServiceService = {
  /** Returns a list of the top level directories of the workspace. */
  getWorkspacePaths: {
    path: "/host.WorkspaceService/getWorkspacePaths" as const,
   ...
   */
  saveOpenDocumentIfDirty: {
    path: "/host.WorkspaceService/saveOpenDocumentIfDirty" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  /** Get diagnostics from the workspace. */
  getDiagnostics: {
    path: "/host.WorkspaceService/getDiagnostics" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  /** Makes the problems panel/pane visible in the IDE and focuses it. */
  openProblemsPanel: {
    path: "/host.WorkspaceService/openProblemsPanel" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  /** Opens the IDE file explorer panel and selects a file or directory. */
  openInFileExplorerPanel: {
    path: "/host.WorkspaceService/openInFileExplorerPanel" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  /** Opens and focuses the DietCode sidebar panel in the host IDE. */
  openDietCodeSidebarPanel: {
    path: "/host.WorkspaceService/openDietCodeSidebarPanel" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: OpenDietCodeSidebarPanelRequest): Buffer =>
      Buffer.from(OpenDietCodeSidebarPanelRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): OpenDietCodeSidebarPanelRequest =>
      OpenDietCodeSidebarPanelRequest.decode(value),
    responseSerialize: (value: OpenDietCodeSidebarPanelResponse): Buffer =>
      Buffer.from(OpenDietCodeSidebarPanelResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): OpenDietCodeSidebarPanelResponse =>
      OpenDietCodeSidebarPanelResponse.decode(value),
  },
  /** Opens and focuses the terminal panel. */
  openTerminalPanel: {
    path: "/host.WorkspaceService/openTerminalPanel" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  /** Executes a command in a new terminal */
  executeCommandInTerminal: {
    path: "/host.WorkspaceService/executeCommandInTerminal" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  /** Opens a folder/workspace in the IDE */
  openFolder: {
    path: "/host.WorkspaceService/openFolder" as const,
    requestStream: false as const,
    responseStream: false as const,
...
export interface WorkspaceServiceServer extends UntypedServiceImplementation {
  ...
  /** Opens and focuses the DietCode sidebar panel in the host IDE. */
  openDietCodeSidebarPanel: handleUnaryCall<OpenDietCodeSidebarPanelRequest, OpenDietCodeSidebarPanelResponse>;
  /** Opens and focuses the terminal panel. */
...
export interface WorkspaceServiceClient extends Client {
  ...
  /** Opens and focuses the DietCode sidebar panel in the host IDE. */
  openDietCodeSidebarPanel(
    request: OpenDietCodeSidebarPanelRequest,
    callback: (error: ServiceError | null, response: OpenDietCodeSidebarPanelResponse) => void,
  ): ClientUnaryCall;
  openDietCodeSidebarPanel(
    request: OpenDietCodeSidebarPanelRequest,
    metadata: Metadata,
