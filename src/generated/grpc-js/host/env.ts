...
import { Empty, EmptyRequest, String, StringRequest } from "../dietcode/common";
...
export interface GetHostVersionResponse {
	 ...
	 * plugin.
	 */
	dietcodeType?: string | undefined;
	/** The version of the dietcode host environment, e.g. 33.2.10 for extension, or 1.0.6 for JetBrains. */
	dietcodeVersion?: string | undefined;
}
...
function createBaseGetHostVersionResponse(): GetHostVersionResponse {
	return {
		platform: undefined,
		version: undefined,
		dietcodeType: undefined,
		dietcodeVersion: undefined,
	};
}
...
export const GetHostVersionResponse: MessageFns<GetHostVersionResponse> = {
	encode(
		...
		if (message.dietcodeType !== undefined) {
			writer.uint32(26).string(message.dietcodeType);
		}
		if (message.dietcodeVersion !== undefined) {
			writer.uint32(34).string(message.dietcodeVersion);
		}
		return writer;
	},
			...
			while (reader.pos < end) {
				...
				switch (tag >>> 3) {
					...
					case 3: {
						...
						message.dietcodeType = reader.string();
						continue;
					}
					case 4: {
						if (tag !== 34) {
						...
						message.dietcodeVersion = reader.string();
						continue;
					}
				}
				if ((tag & 7) === 4 || tag === 0) {
	...
	fromJSON(object: any): GetHostVersionResponse {
		return {
			...
			version: isSet(object.version)
				...
				: undefined,
			dietcodeType: isSet(object.dietcodeType)
				? globalThis.String(object.dietcodeType)
				: isSet(object.dietcode_type)
					? globalThis.String(object.dietcode_type)
					: undefined,
			dietcodeVersion: isSet(object.dietcodeVersion)
				? globalThis.String(object.dietcodeVersion)
				: isSet(object.dietcode_version)
					? globalThis.String(object.dietcode_version)
					: undefined,
		};
	},
	...
	toJSON(message: GetHostVersionResponse): unknown {
		...
		if (message.dietcodeType !== undefined) {
			obj.dietcodeType = message.dietcodeType;
		}
		if (message.dietcodeVersion !== undefined) {
			obj.dietcodeVersion = message.dietcodeVersion;
		}
		return obj;
	},
	...
	fromPartial<I extends Exact<DeepPartial<GetHostVersionResponse>, I>>(
		...
		message.dietcodeType = object.dietcodeType ?? undefined;
		message.dietcodeVersion = object.dietcodeVersion ?? undefined;
		return message;
	},
};
...
export const EnvServiceDefinition = {
	...
	methods: {
		...
		getHostVersion: {
			...
			requestType: EmptyRequest as typeof EmptyRequest,
			requestStream: false,
			responseType: GetHostVersionResponse as typeof GetHostVersionResponse,
			responseStream: false,
			options: {},
		},
		/**
		...
		getTelemetrySettings: {
			...
			requestStream: false,
			responseType:
				GetTelemetrySettingsResponse as typeof GetTelemetrySettingsResponse,
			responseStream: false,
			options: {},
		},
		...
		subscribeToTelemetrySettings: {
			...
			requestType: EmptyRequest as typeof EmptyRequest,
			requestStream: false,
			responseType: TelemetrySettingsEvent as typeof TelemetrySettingsEvent,
			responseStream: true,
			options: {},
		},
...
export const EnvServiceService = {
	/** Writes text to the system clipboard. */
	clipboardWriteText: {
		path: "/host.EnvService/clipboardWriteText" as const,
	...
	/** Reads text from the system clipboard. */
	clipboardReadText: {
		path: "/host.EnvService/clipboardReadText" as const,
		requestStream: false as const,
		responseStream: false as const,
	...
	/** Returns the name and version of the host IDE or environment. */
	getHostVersion: {
		path: "/host.EnvService/getHostVersion" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
		...
		responseDeserialize: (value: Buffer): GetHostVersionResponse =>
			GetHostVersionResponse.decode(value),
	},
	/**
	 * Returns a URI that will redirect to the host environment.
	 * e.g. vscode://saoudrizwan.claude-dev, idea://, pycharm://, etc.
	 ...
	 */
	getIdeRedirectUri: {
		path: "/host.EnvService/getIdeRedirectUri" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
	 ...
	 */
	getTelemetrySettings: {
		path: "/host.EnvService/getTelemetrySettings" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
		...
		responseDeserialize: (value: Buffer): GetTelemetrySettingsResponse =>
			GetTelemetrySettingsResponse.decode(value),
	},
	/** Returns events when the telemetry settings change. */
	subscribeToTelemetrySettings: {
		path: "/host.EnvService/subscribeToTelemetrySettings" as const,
		requestStream: false as const,
		...
		responseDeserialize: (value: Buffer): TelemetrySettingsEvent =>
			TelemetrySettingsEvent.decode(value),
	},
	/** Initiates a graceful shutdown of the host bridge service. */
	shutdown: {
		path: "/host.EnvService/shutdown" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
	...
	/** Logs a debug message to the host environment's log/output console. */
	debugLog: {
		path: "/host.EnvService/debugLog" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: StringRequest): Buffer =>
			Buffer.from(StringRequest.encode(value).finish()),
	 ...
	 */
	openExternal: {
		path: "/host.EnvService/openExternal" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: StringRequest): Buffer =>
			Buffer.from(StringRequest.encode(value).finish()),
...
export interface EnvServiceServer extends UntypedServiceImplementation {
	 ...
	 * if the host does not specify telemetry settings for the plugin.
	 */
	getTelemetrySettings: handleUnaryCall<
		EmptyRequest,
		GetTelemetrySettingsResponse
	>;
	/** Returns events when the telemetry settings change. */
	subscribeToTelemetrySettings: handleServerStreamingCall<
		EmptyRequest,
		TelemetrySettingsEvent
	>;
	/** Initiates a graceful shutdown of the host bridge service. */
...
export interface EnvServiceClient extends Client {
	...
	getHostVersion(
		...
		callback: (
			...
			response: GetHostVersionResponse,
		) => void,
	): ClientUnaryCall;
	getHostVersion(
		request: EmptyRequest,
...
export const EnvServiceClient = makeGenericClientConstructor(
	EnvServiceService,
	"host.EnvService",
) as unknown as {
	new (
