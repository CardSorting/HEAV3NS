...
export const WindowServiceService = {
	/** Opens a text document in the IDE editor and returns editor information. */
	showTextDocument: {
		path: "/host.WindowService/showTextDocument" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: ShowTextDocumentRequest): Buffer =>
			Buffer.from(ShowTextDocumentRequest.encode(value).finish()),
		requestDeserialize: (value: Buffer): ShowTextDocumentRequest =>
			ShowTextDocumentRequest.decode(value),
		responseSerialize: (value: TextEditorInfo): Buffer =>
			Buffer.from(TextEditorInfo.encode(value).finish()),
		responseDeserialize: (value: Buffer): TextEditorInfo =>
			TextEditorInfo.decode(value),
	},
	/** Shows the open file dialogue / file picker. */
	showOpenDialogue: {
		path: "/host.WindowService/showOpenDialogue" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: ShowOpenDialogueRequest): Buffer =>
			Buffer.from(ShowOpenDialogueRequest.encode(value).finish()),
		requestDeserialize: (value: Buffer): ShowOpenDialogueRequest =>
			ShowOpenDialogueRequest.decode(value),
		responseSerialize: (value: SelectedResources): Buffer =>
			Buffer.from(SelectedResources.encode(value).finish()),
		responseDeserialize: (value: Buffer): SelectedResources =>
			SelectedResources.decode(value),
	},
	/** Shows a notification. */
	showMessage: {
		path: "/host.WindowService/showMessage" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: ShowMessageRequest): Buffer =>
			Buffer.from(ShowMessageRequest.encode(value).finish()),
		requestDeserialize: (value: Buffer): ShowMessageRequest =>
			ShowMessageRequest.decode(value),
		responseSerialize: (value: SelectedResponse): Buffer =>
			Buffer.from(SelectedResponse.encode(value).finish()),
		responseDeserialize: (value: Buffer): SelectedResponse =>
			SelectedResponse.decode(value),
	},
	/** Prompts the user for input and returns the response. */
	showInputBox: {
		path: "/host.WindowService/showInputBox" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: ShowInputBoxRequest): Buffer =>
			Buffer.from(ShowInputBoxRequest.encode(value).finish()),
		requestDeserialize: (value: Buffer): ShowInputBoxRequest =>
			ShowInputBoxRequest.decode(value),
		responseSerialize: (value: ShowInputBoxResponse): Buffer =>
			Buffer.from(ShowInputBoxResponse.encode(value).finish()),
		responseDeserialize: (value: Buffer): ShowInputBoxResponse =>
			ShowInputBoxResponse.decode(value),
	},
	/** Shows the file save dialogue / file picker. */
	showSaveDialog: {
		path: "/host.WindowService/showSaveDialog" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: ShowSaveDialogRequest): Buffer =>
			Buffer.from(ShowSaveDialogRequest.encode(value).finish()),
		requestDeserialize: (value: Buffer): ShowSaveDialogRequest =>
			ShowSaveDialogRequest.decode(value),
		responseSerialize: (value: ShowSaveDialogResponse): Buffer =>
			Buffer.from(ShowSaveDialogResponse.encode(value).finish()),
		responseDeserialize: (value: Buffer): ShowSaveDialogResponse =>
			ShowSaveDialogResponse.decode(value),
	},
	/** Opens a file in the IDE. */
	openFile: {
		path: "/host.WindowService/openFile" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: OpenFileRequest): Buffer =>
			Buffer.from(OpenFileRequest.encode(value).finish()),
		requestDeserialize: (value: Buffer): OpenFileRequest =>
			OpenFileRequest.decode(value),
		responseSerialize: (value: OpenFileResponse): Buffer =>
			Buffer.from(OpenFileResponse.encode(value).finish()),
		responseDeserialize: (value: Buffer): OpenFileResponse =>
			OpenFileResponse.decode(value),
	},
	/** Opens the host settings UI, optionally focusing a specific query/section. */
	openSettings: {
		path: "/host.WindowService/openSettings" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: OpenSettingsRequest): Buffer =>
			Buffer.from(OpenSettingsRequest.encode(value).finish()),
		requestDeserialize: (value: Buffer): OpenSettingsRequest =>
			OpenSettingsRequest.decode(value),
		responseSerialize: (value: OpenSettingsResponse): Buffer =>
			Buffer.from(OpenSettingsResponse.encode(value).finish()),
		responseDeserialize: (value: Buffer): OpenSettingsResponse =>
			OpenSettingsResponse.decode(value),
	},
	/** Returns the open tabs. */
	getOpenTabs: {
		path: "/host.WindowService/getOpenTabs" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: GetOpenTabsRequest): Buffer =>
			Buffer.from(GetOpenTabsRequest.encode(value).finish()),
		requestDeserialize: (value: Buffer): GetOpenTabsRequest =>
			GetOpenTabsRequest.decode(value),
		responseSerialize: (value: GetOpenTabsResponse): Buffer =>
			Buffer.from(GetOpenTabsResponse.encode(value).finish()),
		responseDeserialize: (value: Buffer): GetOpenTabsResponse =>
			GetOpenTabsResponse.decode(value),
	},
	/** Returns the visible tabs. */
	getVisibleTabs: {
		path: "/host.WindowService/getVisibleTabs" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: GetVisibleTabsRequest): Buffer =>
			Buffer.from(GetVisibleTabsRequest.encode(value).finish()),
		requestDeserialize: (value: Buffer): GetVisibleTabsRequest =>
			GetVisibleTabsRequest.decode(value),
		responseSerialize: (value: GetVisibleTabsResponse): Buffer =>
			Buffer.from(GetVisibleTabsResponse.encode(value).finish()),
		responseDeserialize: (value: Buffer): GetVisibleTabsResponse =>
			GetVisibleTabsResponse.decode(value),
	},
	/** Returns information about the current editor */
	getActiveEditor: {
		path: "/host.WindowService/getActiveEditor" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: GetActiveEditorRequest): Buffer =>
			Buffer.from(GetActiveEditorRequest.encode(value).finish()),
		requestDeserialize: (value: Buffer): GetActiveEditorRequest =>
			GetActiveEditorRequest.decode(value),
		responseSerialize: (value: GetActiveEditorResponse): Buffer =>
			Buffer.from(GetActiveEditorResponse.encode(value).finish()),
		responseDeserialize: (value: Buffer): GetActiveEditorResponse =>
			GetActiveEditorResponse.decode(value),
	},
} as const;
...
export interface WindowServiceServer extends UntypedServiceImplementation {
	...
	/** Shows the file save dialogue / file picker. */
	showSaveDialog: handleUnaryCall<
		ShowSaveDialogRequest,
		ShowSaveDialogResponse
	>;
	/** Opens a file in the IDE. */
	...
	/** Returns the visible tabs. */
	getVisibleTabs: handleUnaryCall<
		GetVisibleTabsRequest,
		GetVisibleTabsResponse
	>;
	/** Returns information about the current editor */
	getActiveEditor: handleUnaryCall<
		GetActiveEditorRequest,
		GetActiveEditorResponse
	>;
}
...
export interface WindowServiceClient extends Client {
	...
	showSaveDialog(
		...
		callback: (
			error: ServiceError | null,
			response: ShowSaveDialogResponse,
		) => void,
	): ClientUnaryCall;
	showSaveDialog(
		request: ShowSaveDialogRequest,
	...
	getVisibleTabs(
		...
		callback: (
			error: ServiceError | null,
			response: GetVisibleTabsResponse,
		) => void,
	): ClientUnaryCall;
	getVisibleTabs(
		request: GetVisibleTabsRequest,
	...
	getActiveEditor(
		...
		callback: (
			error: ServiceError | null,
			response: GetActiveEditorResponse,
		) => void,
	): ClientUnaryCall;
	getActiveEditor(
		request: GetActiveEditorRequest,
