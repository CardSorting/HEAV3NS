...
export const TestingServiceService = {
  getWebviewHtml: {
    path: "/host.TestingService/getWebviewHtml" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: GetWebviewHtmlRequest): Buffer =>
      Buffer.from(GetWebviewHtmlRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): GetWebviewHtmlRequest => GetWebviewHtmlRequest.decode(value),
    responseSerialize: (value: GetWebviewHtmlResponse): Buffer =>
      Buffer.from(GetWebviewHtmlResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): GetWebviewHtmlResponse => GetWebviewHtmlResponse.decode(value),
  },
} as const;
