...
//   protoc               v5.29.3
// source: dietcode/oca_account.proto
...
export const OcaAuthState: MessageFns<OcaAuthState> = {
	...
	create<I extends Exact<DeepPartial<OcaAuthState>, I>>(
		base?: I,
	): OcaAuthState {
		return OcaAuthState.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<OcaAuthState>, I>>(
		object: I,
	): OcaAuthState {
		const message = createBaseOcaAuthState();
		message.user =
...
export const OcaUserInfo: MessageFns<OcaUserInfo> = {
	...
	fromPartial<I extends Exact<DeepPartial<OcaUserInfo>, I>>(
		object: I,
	): OcaUserInfo {
		const message = createBaseOcaUserInfo();
...
export const OcaAccountServiceDefinition = {
	...
	fullName: "dietcode.OcaAccountService",
	methods: {
		/**
		...
		ocaSubscribeToAuthStatusUpdate: {
			...
			requestType: EmptyRequest as typeof EmptyRequest,
			requestStream: false,
			responseType: OcaAuthState as typeof OcaAuthState,
			responseStream: true,
			options: {},
		},
	},
...
export const OcaAccountServiceService = {
	 ...
	 */
	ocaAccountLoginClicked: {
		path: "/dietcode.OcaAccountService/ocaAccountLoginClicked" as const,
	 ...
	 */
	ocaAccountLogoutClicked: {
		path: "/dietcode.OcaAccountService/ocaAccountLogoutClicked" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
	...
	/** Subscribe to auth status update events (when authentication state changes) */
	ocaSubscribeToAuthStatusUpdate: {
		path: "/dietcode.OcaAccountService/ocaSubscribeToAuthStatusUpdate" as const,
		requestStream: false as const,
		...
		requestDeserialize: (value: Buffer): EmptyRequest =>
			EmptyRequest.decode(value),
		responseSerialize: (value: OcaAuthState): Buffer =>
			Buffer.from(OcaAuthState.encode(value).finish()),
		responseDeserialize: (value: Buffer): OcaAuthState =>
			OcaAuthState.decode(value),
	},
} as const;
...
export interface OcaAccountServiceServer extends UntypedServiceImplementation {
	...
	/** Subscribe to auth status update events (when authentication state changes) */
	ocaSubscribeToAuthStatusUpdate: handleServerStreamingCall<
		EmptyRequest,
		OcaAuthState
	>;
}
