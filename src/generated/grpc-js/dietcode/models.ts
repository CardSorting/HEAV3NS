...
export interface ModelsServiceServer extends UntypedServiceImplementation {
  ...
  /** Refreshes and returns DietCode provider models */
  refreshDietCodeModelsRpc: handleUnaryCall<EmptyRequest, OpenRouterCompatibleModelInfo>;
  /** Refreshes and returns Hugging Face models */
  ...
  /** Refreshes and returns NousResearch models */
  refreshNousResearchModelsRpc: handleUnaryCall<EmptyRequest, OpenRouterCompatibleModelInfo>;
}
