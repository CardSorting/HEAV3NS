...
export const ProviderModelInfo: MessageFns<ProviderModelInfo> = {
  ...
  create<I extends Exact<DeepPartial<ProviderModelInfo>, I>>(base?: I): ProviderModelInfo {
    return ProviderModelInfo.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ProviderModelInfo>, I>>(object: I): ProviderModelInfo {
    const message = createBaseProviderModelInfo();
...
export const ProviderModelCatalog: MessageFns<ProviderModelCatalog> = {
  ...
  create<I extends Exact<DeepPartial<ProviderModelCatalog>, I>>(base?: I): ProviderModelCatalog {
    return ProviderModelCatalog.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ProviderModelCatalog>, I>>(object: I): ProviderModelCatalog {
    const message = createBaseProviderModelCatalog();
...
export const ProviderModelCatalog_ModelsEntry: MessageFns<ProviderModelCatalog_ModelsEntry> = {
  ...
  create<I extends Exact<DeepPartial<ProviderModelCatalog_ModelsEntry>, I>>(
    base?: I,
  ): ProviderModelCatalog_ModelsEntry {
    return ProviderModelCatalog_ModelsEntry.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ProviderModelCatalog_ModelsEntry>, I>>(
    object: I,
  ): ProviderModelCatalog_ModelsEntry {
    const message = createBaseProviderModelCatalog_ModelsEntry();
...
export const DietCodeRecommendedModel: MessageFns<DietCodeRecommendedModel> = {
  encode(message: DietCodeRecommendedModel, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DietCodeRecommendedModel {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
  ...
  create<I extends Exact<DeepPartial<DietCodeRecommendedModel>, I>>(base?: I): DietCodeRecommendedModel {
    return DietCodeRecommendedModel.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DietCodeRecommendedModel>, I>>(object: I): DietCodeRecommendedModel {
    const message = createBaseDietCodeRecommendedModel();
...
export const DietCodeRecommendedModelsResponse: MessageFns<DietCodeRecommendedModelsResponse> = {
  encode(message: DietCodeRecommendedModelsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DietCodeRecommendedModelsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          case 1: {
            ...
            message.recommended.push(DietCodeRecommendedModel.decode(reader, reader.uint32()));
            continue;
          }
          case 2: {
            if (tag !== 18) {
            ...
            message.free.push(DietCodeRecommendedModel.decode(reader, reader.uint32()));
            continue;
          }
        }
        if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): DietCodeRecommendedModelsResponse {
    return {
      recommended: globalThis.Array.isArray(object?.recommended)
        ? object.recommended.map((e: any) => DietCodeRecommendedModel.fromJSON(e))
        : [],
  ...
  toJSON(message: DietCodeRecommendedModelsResponse): unknown {
    ...
    if (message.recommended?.length) {
      obj.recommended = message.recommended.map((e) => DietCodeRecommendedModel.toJSON(e));
    }
  ...
  fromPartial<I extends Exact<DeepPartial<DietCodeRecommendedModelsResponse>, I>>(
    object: I,
  ): DietCodeRecommendedModelsResponse {
    const message = createBaseDietCodeRecommendedModelsResponse();
    message.recommended = object.recommended?.map((e) => DietCodeRecommendedModel.fromPartial(e)) || [];
    message.free = object.free?.map((e) => DietCodeRecommendedModel.fromPartial(e)) || [];
    return message;
  },
};
...
function createBaseUpdateApiConfigurationPartialRequest(): UpdateApiConfigurationPartialRequest {
  return { metadata: undefined, apiConfiguration: undefined, updateMask: undefined, flushImmediately: undefined };
}
...
export const ModelsServiceDefinition = {
  ...
  methods: {
    ...
    refreshDietCodeRecommendedModelsRpc: {
      ...
      requestType: EmptyRequest as typeof EmptyRequest,
      requestStream: false,
      responseType: DietCodeRecommendedModelsResponse as typeof DietCodeRecommendedModelsResponse,
      responseStream: false,
      options: {},
    },
...
export const ModelsServiceService = {
  ...
  refreshDietCodeModelsRpc: {
    ...
    requestSerialize: (value: EmptyRequest): Buffer => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): EmptyRequest => EmptyRequest.decode(value),
    responseSerialize: (value: ProviderModelCatalog): Buffer =>
      Buffer.from(ProviderModelCatalog.encode(value).finish()),
    responseDeserialize: (value: Buffer): ProviderModelCatalog => ProviderModelCatalog.decode(value),
  },
  /** Refreshes and returns Hugging Face models */
  refreshHuggingFaceModels: {
...
export interface ModelsServiceServer extends UntypedServiceImplementation {
  ...
  /** Refreshes and returns recommended and free DietCode models */
  refreshDietCodeRecommendedModelsRpc: handleUnaryCall<EmptyRequest, DietCodeRecommendedModelsResponse>;
  /** Refreshes and returns DietCode provider models */
  refreshDietCodeModelsRpc: handleUnaryCall<EmptyRequest, ProviderModelCatalog>;
  /** Refreshes and returns Hugging Face models */
  refreshHuggingFaceModels: handleUnaryCall<EmptyRequest, ProviderModelCatalog>;
  /** Refreshes and returns OpenAI models */
  refreshOpenAiModels: handleUnaryCall<OpenAiModelsRequest, StringArray>;
  /** Refreshes and returns models from the authenticated OpenAI Codex session */
  refreshOpenAiCodexModelsRpc: handleUnaryCall<EmptyRequest, ProviderModelCatalog>;
  /** Refreshes and returns Requesty models */
  refreshRequestyModels: handleUnaryCall<EmptyRequest, ProviderModelCatalog>;
  /** Refreshes and returns Hicap models */
  refreshHicapModels: handleUnaryCall<EmptyRequest, ProviderModelCatalog>;
  /** Refreshes and returns LiteLLM models */
  refreshLiteLlmModelsRpc: handleUnaryCall<EmptyRequest, ProviderModelCatalog>;
  /** Subscribe to LiteLLM models updates */
  subscribeToLiteLlmModels: handleServerStreamingCall<EmptyRequest, ProviderModelCatalog>;
  /** Updates API configuration (legacy - uses combined configuration) */
  ...
  /** Refreshes and returns Groq models */
  refreshGroqModelsRpc: handleUnaryCall<EmptyRequest, ProviderModelCatalog>;
  /** Refreshes and returns Baseten models */
  refreshBasetenModelsRpc: handleUnaryCall<EmptyRequest, ProviderModelCatalog>;
  /** Fetches available models from SAP AI Core */
  ...
  /** Fetches available models from AIhubmix */
  getAihubmixModels: handleUnaryCall<EmptyRequest, ProviderModelCatalog>;
  /** Refreshes and returns Vercel AI Gateway models */
  refreshVercelAiGatewayModelsRpc: handleUnaryCall<EmptyRequest, ProviderModelCatalog>;
  /** Refreshes and returns NousResearch models */
  refreshNousResearchModelsRpc: handleUnaryCall<EmptyRequest, ProviderModelCatalog>;
}
...
export interface ModelsServiceClient extends Client {
  ...
  refreshDietCodeRecommendedModelsRpc(
    request: EmptyRequest,
    callback: (error: ServiceError | null, response: DietCodeRecommendedModelsResponse) => void,
  ): ClientUnaryCall;
  refreshDietCodeRecommendedModelsRpc(
    request: EmptyRequest,
    metadata: Metadata,
  ...
  refreshDietCodeModelsRpc(
    request: EmptyRequest,
    callback: (error: ServiceError | null, response: ProviderModelCatalog) => void,
  ): ClientUnaryCall;
  refreshDietCodeModelsRpc(
    request: EmptyRequest,
    metadata: Metadata,
  ...
  subscribeToLiteLlmModels(
    request: EmptyRequest,
    options?: Partial<CallOptions>,
  ): ClientReadableStream<ProviderModelCatalog>;
  subscribeToLiteLlmModels(
    request: EmptyRequest,
    metadata?: Metadata,
    options?: Partial<CallOptions>,
