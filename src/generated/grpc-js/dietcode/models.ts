...
export function apiProviderFromJSON(object: any): ApiProvider {
	switch (object) {
		...
		case 41:
		case "CLOUDFLARE":
			return ApiProvider.CLOUDFLARE;
		case 42:
		case "GOOGLE_PERSONAL":
			return ApiProvider.GOOGLE_PERSONAL;
		case 43:
		case "CLINE_PASS":
			return ApiProvider.CLINE_PASS;
		case 44:
		case "XAI_OAUTH":
			return ApiProvider.XAI_OAUTH;
		case 45:
...
export function apiProviderToJSON(object: ApiProvider): string {
	switch (object) {
		...
		case ApiProvider.OPENAI_CODEX:
			return "OPENAI_CODEX";
		case ApiProvider.CLOUDFLARE:
			return "CLOUDFLARE";
		case ApiProvider.GOOGLE_PERSONAL:
			return "GOOGLE_PERSONAL";
		case ApiProvider.CLINE_PASS:
			return "CLINE_PASS";
		case ApiProvider.XAI_OAUTH:
			return "XAI_OAUTH";
...
export interface DietCodeRecommendedModelsResponse {
...
export interface UpdateApiConfigurationPartialRequest {
	...
	/**
	 * Persist this update before returning instead of waiting for the backend storage debounce.
	 * Credential inputs and other settings that must survive an immediate shutdown should set this.
	 */
...
export const VsCodeLmModelsArray: MessageFns<VsCodeLmModelsArray> = {
	...
	toJSON(message: VsCodeLmModelsArray): unknown {
		...
		if (message.models?.length) {
			obj.models = message.models.map((e) =>
				LanguageModelChatSelector.toJSON(e),
			);
		}
		return obj;
	},

	create<I extends Exact<DeepPartial<VsCodeLmModelsArray>, I>>(
		base?: I,
	): VsCodeLmModelsArray {
	...
	fromPartial<I extends Exact<DeepPartial<VsCodeLmModelsArray>, I>>(
		...
		const message = createBaseVsCodeLmModelsArray();
		message.models =
			object.models?.map((e) => LanguageModelChatSelector.fromPartial(e)) || [];
		return message;
	},
};
		...
		fromJSON(object: any): LanguageModelChatSelector {
			return {
				...
				family: isSet(object.family)
					? globalThis.String(object.family)
					: undefined,
...
export const PriceTier: MessageFns<PriceTier> = {
	...
	fromPartial<I extends Exact<DeepPartial<PriceTier>, I>>(
		object: I,
	): PriceTier {
		const message = createBasePriceTier();
...
export const ThinkingConfig: MessageFns<ThinkingConfig> = {
			...
			while (reader.pos < end) {
				...
				switch (tag >>> 3) {
					...
					case 3: {
						...
						message.outputPriceTiers.push(
							PriceTier.decode(reader, reader.uint32()),
						);
						continue;
					}
				}
	...
	toJSON(message: ThinkingConfig): unknown {
		...
		if (message.outputPriceTiers?.length) {
			obj.outputPriceTiers = message.outputPriceTiers.map((e) =>
				PriceTier.toJSON(e),
			);
		}
		return obj;
	...
	create<I extends Exact<DeepPartial<ThinkingConfig>, I>>(
		base?: I,
	): ThinkingConfig {
		return ThinkingConfig.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<ThinkingConfig>, I>>(
		object: I,
	): ThinkingConfig {
		const message = createBaseThinkingConfig();
		message.maxBudget = object.maxBudget ?? undefined;
		message.outputPrice = object.outputPrice ?? undefined;
		message.outputPriceTiers =
			object.outputPriceTiers?.map((e) => PriceTier.fromPartial(e)) || [];
		return message;
	},
};
...
export const ModelTier: MessageFns<ModelTier> = {
	...
	fromPartial<I extends Exact<DeepPartial<ModelTier>, I>>(
		object: I,
	): ModelTier {
		const message = createBaseModelTier();
...
export const OpenRouterModelInfo: MessageFns<OpenRouterModelInfo> = {
			...
			while (reader.pos < end) {
				...
				switch (tag >>> 3) {
					...
					case 10: {
						...
						message.thinkingConfig = ThinkingConfig.decode(
							reader,
							reader.uint32(),
						);
						continue;
	...
	create<I extends Exact<DeepPartial<OpenRouterModelInfo>, I>>(
		base?: I,
	): OpenRouterModelInfo {
				...
				while (reader.pos < end) {
					...
					switch (tag >>> 3) {
						case 1: {
							...
							const entry1 = OpenRouterCompatibleModelInfo_ModelsEntry.decode(
								reader,
								reader.uint32(),
							);
		...
		fromJSON(object: any): OpenRouterCompatibleModelInfo {
			return {
				models: isObject(object.models)
					? (
							globalThis.Object.entries(object.models) as [string, any][]
						).reduce(
							(
...
export const OpenRouterCompatibleModelInfo_ModelsEntry: MessageFns<OpenRouterCompatibleModelInfo_ModelsEntry> =
	{
				...
				while (reader.pos < end) {
					...
					switch (tag >>> 3) {
						...
						case 2: {
							...
							message.value = OpenRouterModelInfo.decode(
								reader,
								reader.uint32(),
							);
							continue;
		...
		fromJSON(object: any): OpenRouterCompatibleModelInfo_ModelsEntry {
			return {
				...
				value: isSet(object.value)
					? OpenRouterModelInfo.fromJSON(object.value)
					: undefined,
			};
		},
		...
		create<
			I extends Exact<
				DeepPartial<OpenRouterCompatibleModelInfo_ModelsEntry>,
				I
			>,
		>(base?: I): OpenRouterCompatibleModelInfo_ModelsEntry {
			return OpenRouterCompatibleModelInfo_ModelsEntry.fromPartial(
				base ?? ({} as any),
			);
		},
		fromPartial<
			I extends Exact<
				...
				I
			>,
		>(object: I): OpenRouterCompatibleModelInfo_ModelsEntry {
			const message = createBaseOpenRouterCompatibleModelInfo_ModelsEntry();
...
function createBaseDietCodeRecommendedModel(): DietCodeRecommendedModel {
	return { id: "", name: "", description: "", tags: [] };
}

export const DietCodeRecommendedModel: MessageFns<DietCodeRecommendedModel> = {
	encode(
		message: DietCodeRecommendedModel,
		writer: BinaryWriter = new BinaryWriter(),
	): BinaryWriter {
		if (message.id !== "") {
	...
	decode(
		...
		try {
			const end = length === undefined ? reader.len : reader.pos + length;
			const message = createBaseDietCodeRecommendedModel();
			while (reader.pos < end) {
				const tag = reader.uint32();
				switch (tag >>> 3) {
					case 1: {
	...
	fromJSON(object: any): DietCodeRecommendedModel {
		return {
	...
	toJSON(message: DietCodeRecommendedModel): unknown {
		const obj: any = {};
		if (message.id !== "") {
			obj.id = message.id;
		}
	...
	create<I extends Exact<DeepPartial<DietCodeRecommendedModel>, I>>(
		base?: I,
	): DietCodeRecommendedModel {
		return DietCodeRecommendedModel.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<DietCodeRecommendedModel>, I>>(
		object: I,
	): DietCodeRecommendedModel {
		const message = createBaseDietCodeRecommendedModel();
...
function createBaseDietCodeRecommendedModelsResponse(): DietCodeRecommendedModelsResponse {
	return { recommended: [], free: [] };
}

export const DietCodeRecommendedModelsResponse: MessageFns<DietCodeRecommendedModelsResponse> =
	{
		encode(
			message: DietCodeRecommendedModelsResponse,
			writer: BinaryWriter = new BinaryWriter(),
		): BinaryWriter {
			for (const v of message.recommended) {
				DietCodeRecommendedModel.encode(v!, writer.uint32(10).fork()).join();
			}
			for (const v of message.free) {
				DietCodeRecommendedModel.encode(v!, writer.uint32(18).fork()).join();
			}
			return writer;
		},
		...
		decode(
			input: BinaryReader | Uint8Array,
			length?: number,
		): DietCodeRecommendedModelsResponse {
			const reader =
				input instanceof BinaryReader ? input : new BinaryReader(input);
			const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
			if (previousRecursionDepth >= 100) {
			...
			try {
				const end = length === undefined ? reader.len : reader.pos + length;
				const message = createBaseDietCodeRecommendedModelsResponse();
				while (reader.pos < end) {
					const tag = reader.uint32();
					switch (tag >>> 3) {
						case 1: {
							...
							message.recommended.push(
								DietCodeRecommendedModel.decode(reader, reader.uint32()),
							);
							continue;
						}
						case 2: {
		...
		fromJSON(object: any): DietCodeRecommendedModelsResponse {
			return {
				recommended: globalThis.Array.isArray(object?.recommended)
					? object.recommended.map((e: any) =>
							DietCodeRecommendedModel.fromJSON(e),
						)
					: [],
				free: globalThis.Array.isArray(object?.free)
					? object.free.map((e: any) => DietCodeRecommendedModel.fromJSON(e))
					: [],
			};
		},

		toJSON(message: DietCodeRecommendedModelsResponse): unknown {
			const obj: any = {};
			if (message.recommended?.length) {
				obj.recommended = message.recommended.map((e) =>
					DietCodeRecommendedModel.toJSON(e),
				);
			}
			if (message.free?.length) {
				obj.free = message.free.map((e) => DietCodeRecommendedModel.toJSON(e));
			}
			return obj;
		},

		create<I extends Exact<DeepPartial<DietCodeRecommendedModelsResponse>, I>>(
			base?: I,
		): DietCodeRecommendedModelsResponse {
			return DietCodeRecommendedModelsResponse.fromPartial(base ?? ({} as any));
		},
		fromPartial<
			I extends Exact<DeepPartial<DietCodeRecommendedModelsResponse>, I>,
		>(object: I): DietCodeRecommendedModelsResponse {
			const message = createBaseDietCodeRecommendedModelsResponse();
			message.recommended =
				object.recommended?.map((e) =>
					DietCodeRecommendedModel.fromPartial(e),
				) || [];
			message.free =
				object.free?.map((e) => DietCodeRecommendedModel.fromPartial(e)) || [];
			return message;
		},
	};
...
export const OpenAiModelsRequest: MessageFns<OpenAiModelsRequest> = {
	...
	create<I extends Exact<DeepPartial<OpenAiModelsRequest>, I>>(
		base?: I,
	): OpenAiModelsRequest {
				...
				switch (tag >>> 3) {
					case 1: {
						...
						message.deployments.push(
							SapAiCoreModelDeployment.decode(reader, reader.uint32()),
						);
						continue;
					}
					case 2: {
		...
		return {
			deployments: globalThis.Array.isArray(object?.deployments)
				? object.deployments.map((e: any) =>
						SapAiCoreModelDeployment.fromJSON(e),
					)
				: [],
	...
	toJSON(message: SapAiCoreModelsResponse): unknown {
		...
		if (message.deployments?.length) {
			obj.deployments = message.deployments.map((e) =>
				SapAiCoreModelDeployment.toJSON(e),
			);
		}
		if (message.orchestrationAvailable !== false) {
...
export const ModelsApiSecrets: MessageFns<ModelsApiSecrets> = {
	encode(
		...
		if (message.dietcodeApiKey !== undefined) {
			writer.uint32(18).string(message.dietcodeApiKey);
		}
		...
		if (message.dietcodeAccountId !== undefined) {
			writer.uint32(226).string(message.dietcodeAccountId);
		}
		...
		if (message.embeddingApiKey !== undefined) {
			writer.uint32(322).string(message.embeddingApiKey);
		}
		if (message.cloudflareApiToken !== undefined) {
			writer.uint32(330).string(message.cloudflareApiToken);
		}
		if (message.qwenTokenPlanApiKey !== undefined) {
			writer.uint32(338).string(message.qwenTokenPlanApiKey);
		}
		return writer;
	},
	...
	create<I extends Exact<DeepPartial<ModelsApiSecrets>, I>>(
		base?: I,
	): ModelsApiSecrets {
		return ModelsApiSecrets.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<ModelsApiSecrets>, I>>(
		object: I,
	): ModelsApiSecrets {
		const message = createBaseModelsApiSecrets();
...
export const ModelsApiOptions: MessageFns<ModelsApiOptions> = {
	encode(
		...
		if (message.embeddingProvider !== undefined) {
			writer.uint32(360).int32(message.embeddingProvider);
		}
		if (message.embeddingModelId !== undefined) {
			writer.uint32(370).string(message.embeddingModelId);
		}
		if (message.embeddingOpenAiBaseUrl !== undefined) {
			writer.uint32(378).string(message.embeddingOpenAiBaseUrl);
		}
		if (message.cloudflareAccountId !== undefined) {
			writer.uint32(386).string(message.cloudflareAccountId);
		}
			...
			while (reader.pos < end) {
				...
				switch (tag >>> 3) {
					...
					case 4: {
						...
						const entry4 = ModelsApiOptions_OpenAiHeadersEntry.decode(
							reader,
							reader.uint32(),
						);
					...
					case 22: {
						...
						message.fireworksModelMaxCompletionTokens = longToNumber(
							reader.int64(),
						);
						continue;
					}
	...
	fromJSON(object: any): ModelsApiOptions {
		return {
			...
			planModeDietcodeModelId: isSet(object.planModeDietcodeModelId)
				...
				: isSet(object.plan_mode_dietcode_model_id)
			...
			actModeDietcodeModelId: isSet(object.actModeDietcodeModelId)
				...
				: isSet(object.act_mode_dietcode_model_id)
	...
	create<I extends Exact<DeepPartial<ModelsApiOptions>, I>>(
		base?: I,
	): ModelsApiOptions {
		return ModelsApiOptions.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<ModelsApiOptions>, I>>(
		object: I,
	): ModelsApiOptions {
		const message = createBaseModelsApiOptions();
...
export const ModelsApiOptions_OpenAiHeadersEntry: MessageFns<ModelsApiOptions_OpenAiHeadersEntry> =
	{
		...
		create<
			I extends Exact<DeepPartial<ModelsApiOptions_OpenAiHeadersEntry>, I>,
		>(base?: I): ModelsApiOptions_OpenAiHeadersEntry {
			return ModelsApiOptions_OpenAiHeadersEntry.fromPartial(
				base ?? ({} as any),
			);
		},
		fromPartial<
			I extends Exact<DeepPartial<ModelsApiOptions_OpenAiHeadersEntry>, I>,
		>(object: I): ModelsApiOptions_OpenAiHeadersEntry {
			const message = createBaseModelsApiOptions_OpenAiHeadersEntry();
			message.key = object.key ?? "";
		...
		fromPartial<I extends Exact<DeepPartial<UpdateApiConfigurationRequest>, I>>(
			...
			message.metadata =
				object.metadata !== undefined && object.metadata !== null
					...
					: undefined;
			message.apiConfiguration =
				object.apiConfiguration !== undefined &&
				object.apiConfiguration !== null
...
export const ApiConfiguration: MessageFns<ApiConfiguration> = {
	...
	fromJSON(object: any): ApiConfiguration {
		return {
			options: isSet(object.options)
				? ModelsApiOptions.fromJSON(object.options)
				: undefined,
			secrets: isSet(object.secrets)
				? ModelsApiSecrets.fromJSON(object.secrets)
				: undefined,
		};
	},
	...
	create<I extends Exact<DeepPartial<ApiConfiguration>, I>>(
		base?: I,
	): ApiConfiguration {
		return ApiConfiguration.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<ApiConfiguration>, I>>(
		object: I,
	): ApiConfiguration {
		const message = createBaseApiConfiguration();
		message.options =
...
export const UpdateApiConfigurationRequestNew: MessageFns<UpdateApiConfigurationRequestNew> =
	{
				...
				while (reader.pos < end) {
					...
					switch (tag >>> 3) {
						...
						case 2: {
							...
							message.updates = ApiConfiguration.decode(
								reader,
								reader.uint32(),
							);
							continue;
		...
		fromJSON(object: any): UpdateApiConfigurationRequestNew {
			return {
				...
				updates: isSet(object.updates)
					? ApiConfiguration.fromJSON(object.updates)
					: undefined,
		...
		fromPartial<
			I extends Exact<DeepPartial<UpdateApiConfigurationRequestNew>, I>,
		>(object: I): UpdateApiConfigurationRequestNew {
			const message = createBaseUpdateApiConfigurationRequestNew();
			message.metadata =
				object.metadata !== undefined && object.metadata !== null
					? Metadata1.fromPartial(object.metadata)
...
export const UpdateApiConfigurationPartialRequest: MessageFns<UpdateApiConfigurationPartialRequest> =
	{
		encode(
			...
			if (message.flushImmediately !== undefined) {
				writer.uint32(32).bool(message.flushImmediately);
			}
			return writer;
		},
				...
				while (reader.pos < end) {
					...
					switch (tag >>> 3) {
						...
						case 4: {
							...
							message.flushImmediately = reader.bool();
							continue;
						}
					}
					if ((tag & 7) === 4 || tag === 0) {
			...
			return {
				...
				updateMask: isSet(object.updateMask)
					...
					: isSet(object.update_mask)
						...
						: undefined,
				flushImmediately: isSet(object.flushImmediately)
					? globalThis.Boolean(object.flushImmediately)
					: isSet(object.flush_immediately)
						? globalThis.Boolean(object.flush_immediately)
						: undefined,
			};
		},
		...
		toJSON(message: UpdateApiConfigurationPartialRequest): unknown {
			...
			if (message.flushImmediately !== undefined) {
				obj.flushImmediately = message.flushImmediately;
			}
			return obj;
		},

		create<
			I extends Exact<DeepPartial<UpdateApiConfigurationPartialRequest>, I>,
		>(base?: I): UpdateApiConfigurationPartialRequest {
			return UpdateApiConfigurationPartialRequest.fromPartial(
				base ?? ({} as any),
			);
		},
		fromPartial<
			I extends Exact<DeepPartial<UpdateApiConfigurationPartialRequest>, I>,
		>(object: I): UpdateApiConfigurationPartialRequest {
			const message = createBaseUpdateApiConfigurationPartialRequest();
			message.metadata =
				object.metadata !== undefined && object.metadata !== null
					? Metadata1.fromPartial(object.metadata)
			...
			message.flushImmediately = object.flushImmediately ?? undefined;
			return message;
		},
	};
...
export const OcaModelInfo: MessageFns<OcaModelInfo> = {
	...
	fromJSON(object: any): OcaModelInfo {
		return {
			...
			banner: isSet(object.banner)
				? globalThis.String(object.banner)
				: undefined,
			modelName: isSet(object.modelName)
				? globalThis.String(object.modelName)
				: isSet(object.model_name)
			...
			supportsReasoning: isSet(object.supportsReasoning)
				...
				: isSet(object.supports_reasoning)
					? globalThis.Boolean(object.supports_reasoning)
					: undefined,
			reasoningEffortOptions: globalThis.Array.isArray(
				...
				: globalThis.Array.isArray(object?.reasoning_effort_options)
					? object.reasoning_effort_options.map((e: any) =>
							globalThis.String(e),
						)
					: [],
		};
	...
	create<I extends Exact<DeepPartial<OcaModelInfo>, I>>(
		base?: I,
	): OcaModelInfo {
		return OcaModelInfo.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<OcaModelInfo>, I>>(
		object: I,
	): OcaModelInfo {
		const message = createBaseOcaModelInfo();
		message.maxTokens = object.maxTokens ?? undefined;
		...
		message.apiFormat = object.apiFormat ?? undefined;
		message.supportsReasoning = object.supportsReasoning ?? undefined;
		message.reasoningEffortOptions =
			object.reasoningEffortOptions?.map((e) => e) || [];
		return message;
	},
};
			...
			while (reader.pos < end) {
				...
				switch (tag >>> 3) {
					case 1: {
						...
						const entry1 = OcaCompatibleModelInfo_ModelsEntry.decode(
							reader,
							reader.uint32(),
						);
						if (entry1.value !== undefined) {
		...
		return {
			models: isObject(object.models)
				? (globalThis.Object.entries(object.models) as [string, any][]).reduce(
						(
							acc: { [key: string]: OcaModelInfo },
							[key, value]: [string, any],
						) => {
							globalThis.Object.defineProperty(acc, key, {
								value: OcaModelInfo.fromJSON(value),
								enumerable: true,
								configurable: true,
								writable: true,
							});
...
export const OcaCompatibleModelInfo_ModelsEntry: MessageFns<OcaCompatibleModelInfo_ModelsEntry> =
	{
		...
		fromJSON(object: any): OcaCompatibleModelInfo_ModelsEntry {
			return {
				key: isSet(object.key) ? globalThis.String(object.key) : "",
				value: isSet(object.value)
					? OcaModelInfo.fromJSON(object.value)
					: undefined,
			};
		},
		...
		create<I extends Exact<DeepPartial<OcaCompatibleModelInfo_ModelsEntry>, I>>(
			...
			return OcaCompatibleModelInfo_ModelsEntry.fromPartial(
				base ?? ({} as any),
			);
		},
		fromPartial<
			I extends Exact<DeepPartial<OcaCompatibleModelInfo_ModelsEntry>, I>,
		>(object: I): OcaCompatibleModelInfo_ModelsEntry {
			const message = createBaseOcaCompatibleModelInfo_ModelsEntry();
			message.key = object.key ?? "";
			message.value =
				object.value !== undefined && object.value !== null
		...
		fromPartial<I extends Exact<DeepPartial<OpenAiCompatibleModelInfo>, I>>(
			...
			message.thinkingConfig =
				object.thinkingConfig !== undefined && object.thinkingConfig !== null
					? ThinkingConfig.fromPartial(object.thinkingConfig)
					: undefined;
			message.supportsGlobalEndpoint =
				object.supportsGlobalEndpoint ?? undefined;
			message.cacheWritesPrice = object.cacheWritesPrice ?? undefined;
			message.cacheReadsPrice = object.cacheReadsPrice ?? undefined;
			message.description = object.description ?? undefined;
			message.tiers = object.tiers?.map((e) => ModelTier.fromPartial(e)) || [];
...
export const LiteLLMModelInfo: MessageFns<LiteLLMModelInfo> = {
	...
	create<I extends Exact<DeepPartial<LiteLLMModelInfo>, I>>(
		base?: I,
	): LiteLLMModelInfo {
		return LiteLLMModelInfo.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<LiteLLMModelInfo>, I>>(
		object: I,
	): LiteLLMModelInfo {
		const message = createBaseLiteLLMModelInfo();
		message.maxTokens = object.maxTokens ?? undefined;
...
export const ModelsApiConfiguration: MessageFns<ModelsApiConfiguration> = {
	encode(
		...
		if (message.dietcodeAccountId !== undefined) {
			writer.uint32(482).string(message.dietcodeAccountId);
		}
		if (message.groqApiKey !== undefined) {
		...
		if (message.embeddingProvider !== undefined) {
			writer.uint32(696).int32(message.embeddingProvider);
		}
		if (message.embeddingModelId !== undefined) {
			writer.uint32(706).string(message.embeddingModelId);
		}
		if (message.embeddingApiKey !== undefined) {
			writer.uint32(714).string(message.embeddingApiKey);
		}
		if (message.embeddingOpenAiBaseUrl !== undefined) {
			writer.uint32(722).string(message.embeddingOpenAiBaseUrl);
		}
		if (message.cloudflareAccountId !== undefined) {
			writer.uint32(730).string(message.cloudflareAccountId);
		}
		if (message.cloudflareApiToken !== undefined) {
			writer.uint32(738).string(message.cloudflareApiToken);
		}
		if (message.clineApiKey !== undefined) {
			writer.uint32(746).string(message.clineApiKey);
		}
		if (message.qwenTokenPlanApiKey !== undefined) {
			...
			while (reader.pos < end) {
				...
				switch (tag >>> 3) {
					...
					case 7: {
						...
						const entry7 = ModelsApiConfiguration_OpenAiHeadersEntry.decode(
							reader,
							reader.uint32(),
						);
...
export const ModelsApiConfiguration_OpenAiHeadersEntry: MessageFns<ModelsApiConfiguration_OpenAiHeadersEntry> =
	{
		...
		create<
			I extends Exact<
				DeepPartial<ModelsApiConfiguration_OpenAiHeadersEntry>,
				I
			>,
		>(base?: I): ModelsApiConfiguration_OpenAiHeadersEntry {
			return ModelsApiConfiguration_OpenAiHeadersEntry.fromPartial(
				base ?? ({} as any),
			);
		},
		fromPartial<
			I extends Exact<
				...
				I
			>,
		>(object: I): ModelsApiConfiguration_OpenAiHeadersEntry {
			const message = createBaseModelsApiConfiguration_OpenAiHeadersEntry();
			message.key = object.key ?? "";
			message.value = object.value ?? "";
			return message;
...
export const ModelsServiceDefinition = {
	name: "ModelsService",
	fullName: "dietcode.ModelsService",
	methods: {
		...
		refreshOpenRouterModelsRpc: {
			...
			requestStream: false,
			responseType:
				OpenRouterCompatibleModelInfo as typeof OpenRouterCompatibleModelInfo,
			responseStream: false,
			options: {},
		},
		...
		refreshDietCodeRecommendedModelsRpc: {
			...
			requestStream: false,
			responseType:
				DietCodeRecommendedModelsResponse as typeof DietCodeRecommendedModelsResponse,
			responseStream: false,
			options: {},
		},
		/** Refreshes and returns DietCode provider models */
		...
		updateApiConfigurationProto: {
			...
			requestType:
				UpdateApiConfigurationRequest as typeof UpdateApiConfigurationRequest,
			requestStream: false,
		...
		updateApiConfiguration: {
			...
			requestType:
				UpdateApiConfigurationRequestNew as typeof UpdateApiConfigurationRequestNew,
			requestStream: false,
			responseType: Empty as typeof Empty,
			responseStream: false,
			options: {},
		...
		updateApiConfigurationPartial: {
			...
			requestType:
				UpdateApiConfigurationPartialRequest as typeof UpdateApiConfigurationPartialRequest,
			requestStream: false,
			responseType: Empty as typeof Empty,
			responseStream: false,
			options: {},
...
export const ModelsServiceService = {
	/** Fetches available models from Ollama */
	getOllamaModels: {
		path: "/dietcode.ModelsService/getOllamaModels" as const,
		...
		responseSerialize: (value: StringArray): Buffer =>
			Buffer.from(StringArray.encode(value).finish()),
		responseDeserialize: (value: Buffer): StringArray =>
			StringArray.decode(value),
	},
	/** Fetches available models from LM Studio */
	getLmStudioModels: {
		path: "/dietcode.ModelsService/getLmStudioModels" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: StringRequest): Buffer =>
			Buffer.from(StringRequest.encode(value).finish()),
	...
	/** Fetches available models from VS Code LM API */
	getVsCodeLmModels: {
		path: "/dietcode.ModelsService/getVsCodeLmModels" as const,
		requestStream: false as const,
		responseStream: false as const,
		...
		responseSerialize: (value: VsCodeLmModelsArray): Buffer =>
			Buffer.from(VsCodeLmModelsArray.encode(value).finish()),
		responseDeserialize: (value: Buffer): VsCodeLmModelsArray =>
			VsCodeLmModelsArray.decode(value),
	},
	/** Refreshes and returns OpenRouter models */
	refreshOpenRouterModelsRpc: {
		path: "/dietcode.ModelsService/refreshOpenRouterModelsRpc" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
		...
		responseDeserialize: (value: Buffer): OpenRouterCompatibleModelInfo =>
			OpenRouterCompatibleModelInfo.decode(value),
	},
	/** Refreshes and returns recommended and free DietCode models */
	refreshDietCodeRecommendedModelsRpc: {
		path: "/dietcode.ModelsService/refreshDietCodeRecommendedModelsRpc" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
		requestDeserialize: (value: Buffer): EmptyRequest =>
			EmptyRequest.decode(value),
		responseSerialize: (value: DietCodeRecommendedModelsResponse): Buffer =>
			Buffer.from(DietCodeRecommendedModelsResponse.encode(value).finish()),
		responseDeserialize: (value: Buffer): DietCodeRecommendedModelsResponse =>
			DietCodeRecommendedModelsResponse.decode(value),
	},
	/** Refreshes and returns DietCode provider models */
	refreshDietCodeModelsRpc: {
		path: "/dietcode.ModelsService/refreshDietCodeModelsRpc" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
	...
	/** Refreshes and returns Hugging Face models */
	refreshHuggingFaceModels: {
		path: "/dietcode.ModelsService/refreshHuggingFaceModels" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
	...
	/** Refreshes and returns OpenAI models */
	refreshOpenAiModels: {
		path: "/dietcode.ModelsService/refreshOpenAiModels" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: OpenAiModelsRequest): Buffer =>
			Buffer.from(OpenAiModelsRequest.encode(value).finish()),
		requestDeserialize: (value: Buffer): OpenAiModelsRequest =>
			OpenAiModelsRequest.decode(value),
		responseSerialize: (value: StringArray): Buffer =>
			Buffer.from(StringArray.encode(value).finish()),
		responseDeserialize: (value: Buffer): StringArray =>
			StringArray.decode(value),
	...
	/** Refreshes and returns Hicap models */
	refreshHicapModels: {
		path: "/dietcode.ModelsService/refreshHicapModels" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
	...
	/** Refreshes and returns LiteLLM models */
	refreshLiteLlmModelsRpc: {
		path: "/dietcode.ModelsService/refreshLiteLlmModelsRpc" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
	...
	/** Subscribe to OpenRouter models updates */
	subscribeToOpenRouterModels: {
		path: "/dietcode.ModelsService/subscribeToOpenRouterModels" as const,
		requestStream: false as const,
	...
	/** Subscribe to LiteLLM models updates */
	subscribeToLiteLlmModels: {
		path: "/dietcode.ModelsService/subscribeToLiteLlmModels" as const,
		requestStream: false as const,
		responseStream: true as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
	...
	/** Updates API configuration (legacy - uses combined configuration) */
	updateApiConfigurationProto: {
		path: "/dietcode.ModelsService/updateApiConfigurationProto" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: UpdateApiConfigurationRequest): Buffer =>
			Buffer.from(UpdateApiConfigurationRequest.encode(value).finish()),
		requestDeserialize: (value: Buffer): UpdateApiConfigurationRequest =>
			UpdateApiConfigurationRequest.decode(value),
	...
	/** Updates API configuration (new - uses separate options and secrets) */
	updateApiConfiguration: {
		path: "/dietcode.ModelsService/updateApiConfiguration" as const,
		requestStream: false as const,
		responseStream: false as const,
	...
	/** Updates API configuration with partial values (only updates fields that are explicitly set) */
	updateApiConfigurationPartial: {
		path: "/dietcode.ModelsService/updateApiConfigurationPartial" as const,
		requestStream: false as const,
		responseStream: false as const,
	...
	/** Refreshes and returns Groq models */
	refreshGroqModelsRpc: {
		path: "/dietcode.ModelsService/refreshGroqModelsRpc" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
	...
	/** Refreshes and returns Baseten models */
	refreshBasetenModelsRpc: {
		path: "/dietcode.ModelsService/refreshBasetenModelsRpc" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
	...
	/** Fetches available models from SAP AI Core */
	getSapAiCoreModels: {
		path: "/dietcode.ModelsService/getSapAiCoreModels" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: SapAiCoreModelsRequest): Buffer =>
			Buffer.from(SapAiCoreModelsRequest.encode(value).finish()),
		requestDeserialize: (value: Buffer): SapAiCoreModelsRequest =>
			SapAiCoreModelsRequest.decode(value),
		responseSerialize: (value: SapAiCoreModelsResponse): Buffer =>
			Buffer.from(SapAiCoreModelsResponse.encode(value).finish()),
		responseDeserialize: (value: Buffer): SapAiCoreModelsResponse =>
			SapAiCoreModelsResponse.decode(value),
	},
	/** Fetches available models from OCA */
	refreshOcaModels: {
		path: "/dietcode.ModelsService/refreshOcaModels" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: StringRequest): Buffer =>
			Buffer.from(StringRequest.encode(value).finish()),
		...
		responseDeserialize: (value: Buffer): OcaCompatibleModelInfo =>
			OcaCompatibleModelInfo.decode(value),
	},
	/** Fetches available models from AIhubmix */
	getAihubmixModels: {
		path: "/dietcode.ModelsService/getAihubmixModels" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
	...
	/** Refreshes and returns Vercel AI Gateway models */
	refreshVercelAiGatewayModelsRpc: {
		path: "/dietcode.ModelsService/refreshVercelAiGatewayModelsRpc" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
	...
	/** Refreshes and returns NousResearch models */
	refreshNousResearchModelsRpc: {
		path: "/dietcode.ModelsService/refreshNousResearchModelsRpc" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
...
export interface ModelsServiceServer extends UntypedServiceImplementation {
	...
	/** Refreshes and returns OpenRouter models */
	refreshOpenRouterModelsRpc: handleUnaryCall<
		EmptyRequest,
		OpenRouterCompatibleModelInfo
	>;
	/** Refreshes and returns recommended and free DietCode models */
	refreshDietCodeRecommendedModelsRpc: handleUnaryCall<
		EmptyRequest,
		DietCodeRecommendedModelsResponse
	>;
	/** Refreshes and returns DietCode provider models */
	refreshDietCodeModelsRpc: handleUnaryCall<
		EmptyRequest,
		OpenRouterCompatibleModelInfo
	>;
	/** Refreshes and returns Hugging Face models */
	refreshHuggingFaceModels: handleUnaryCall<
		EmptyRequest,
		OpenRouterCompatibleModelInfo
	>;
	/** Refreshes and returns OpenAI models */
	...
	/** Refreshes and returns Requesty models */
	refreshRequestyModels: handleUnaryCall<
		EmptyRequest,
		OpenRouterCompatibleModelInfo
	>;
	/** Refreshes and returns Hicap models */
	refreshHicapModels: handleUnaryCall<
		EmptyRequest,
		OpenRouterCompatibleModelInfo
	>;
	/** Refreshes and returns LiteLLM models */
	refreshLiteLlmModelsRpc: handleUnaryCall<
		EmptyRequest,
		OpenRouterCompatibleModelInfo
	>;
	/** Subscribe to OpenRouter models updates */
	subscribeToOpenRouterModels: handleServerStreamingCall<
		EmptyRequest,
		OpenRouterCompatibleModelInfo
	>;
	/** Subscribe to LiteLLM models updates */
	subscribeToLiteLlmModels: handleServerStreamingCall<
		EmptyRequest,
		OpenRouterCompatibleModelInfo
	>;
	/** Updates API configuration (legacy - uses combined configuration) */
	updateApiConfigurationProto: handleUnaryCall<
		UpdateApiConfigurationRequest,
		Empty
	>;
	/** Updates API configuration (new - uses separate options and secrets) */
	updateApiConfiguration: handleUnaryCall<
		UpdateApiConfigurationRequestNew,
		Empty
	>;
	/** Updates API configuration with partial values (only updates fields that are explicitly set) */
	updateApiConfigurationPartial: handleUnaryCall<
		UpdateApiConfigurationPartialRequest,
		Empty
	>;
	/** Refreshes and returns Groq models */
	refreshGroqModelsRpc: handleUnaryCall<
		EmptyRequest,
		OpenRouterCompatibleModelInfo
	>;
	/** Refreshes and returns Baseten models */
	refreshBasetenModelsRpc: handleUnaryCall<
		EmptyRequest,
		OpenRouterCompatibleModelInfo
	>;
	/** Fetches available models from SAP AI Core */
	getSapAiCoreModels: handleUnaryCall<
		SapAiCoreModelsRequest,
		SapAiCoreModelsResponse
	>;
	/** Fetches available models from OCA */
	...
	/** Fetches available models from AIhubmix */
	getAihubmixModels: handleUnaryCall<
		EmptyRequest,
		OpenRouterCompatibleModelInfo
	>;
	/** Refreshes and returns Vercel AI Gateway models */
	refreshVercelAiGatewayModelsRpc: handleUnaryCall<
		EmptyRequest,
		OpenRouterCompatibleModelInfo
	>;
	/** Refreshes and returns NousResearch models */
	refreshNousResearchModelsRpc: handleUnaryCall<
		EmptyRequest,
		OpenRouterCompatibleModelInfo
	>;
}
...
export interface ModelsServiceClient extends Client {
	...
	refreshOpenRouterModelsRpc(
		...
		callback: (
			error: ServiceError | null,
			response: OpenRouterCompatibleModelInfo,
		) => void,
	): ClientUnaryCall;
	refreshOpenRouterModelsRpc(
		request: EmptyRequest,
	...
	refreshDietCodeRecommendedModelsRpc(
		...
		callback: (
			error: ServiceError | null,
			response: DietCodeRecommendedModelsResponse,
		) => void,
	): ClientUnaryCall;
	refreshDietCodeRecommendedModelsRpc(
		request: EmptyRequest,
	...
	getSapAiCoreModels(
		...
		callback: (
			error: ServiceError | null,
			response: SapAiCoreModelsResponse,
		) => void,
	): ClientUnaryCall;
	getSapAiCoreModels(
		request: SapAiCoreModelsRequest,
	...
	refreshOcaModels(
		...
		callback: (
			error: ServiceError | null,
			response: OcaCompatibleModelInfo,
		) => void,
	): ClientUnaryCall;
	refreshOcaModels(
		request: StringRequest,
