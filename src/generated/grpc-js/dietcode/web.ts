...
export const IsImageUrl: MessageFns<IsImageUrl> = {
	...
	fromPartial<I extends Exact<DeepPartial<IsImageUrl>, I>>(
		object: I,
	): IsImageUrl {
		const message = createBaseIsImageUrl();
...
export const OpenGraphData: MessageFns<OpenGraphData> = {
	...
	create<I extends Exact<DeepPartial<OpenGraphData>, I>>(
		base?: I,
	): OpenGraphData {
		return OpenGraphData.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<OpenGraphData>, I>>(
		object: I,
	): OpenGraphData {
		const message = createBaseOpenGraphData();
...
export const WebServiceDefinition = {
	name: "WebService",
	fullName: "dietcode.WebService",
	methods: {
		checkIsImageUrl: {
			name: "checkIsImageUrl",
			requestType: StringRequest as typeof StringRequest,
			requestStream: false,
			responseType: IsImageUrl as typeof IsImageUrl,
		...
		fetchOpenGraphData: {
			...
			requestType: StringRequest as typeof StringRequest,
			requestStream: false,
			responseType: OpenGraphData as typeof OpenGraphData,
			responseStream: false,
			options: {},
		},
		openInBrowser: {
...
export const WebServiceService = {
	checkIsImageUrl: {
		path: "/dietcode.WebService/checkIsImageUrl" as const,
		...
		responseSerialize: (value: IsImageUrl): Buffer =>
			Buffer.from(IsImageUrl.encode(value).finish()),
		responseDeserialize: (value: Buffer): IsImageUrl =>
			IsImageUrl.decode(value),
	},
	fetchOpenGraphData: {
		path: "/dietcode.WebService/fetchOpenGraphData" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: StringRequest): Buffer =>
			Buffer.from(StringRequest.encode(value).finish()),
		requestDeserialize: (value: Buffer): StringRequest =>
			StringRequest.decode(value),
		responseSerialize: (value: OpenGraphData): Buffer =>
			Buffer.from(OpenGraphData.encode(value).finish()),
		responseDeserialize: (value: Buffer): OpenGraphData =>
			OpenGraphData.decode(value),
	},
	openInBrowser: {
		path: "/dietcode.WebService/openInBrowser" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: StringRequest): Buffer =>
			Buffer.from(StringRequest.encode(value).finish()),
...
export const WebServiceClient = makeGenericClientConstructor(
	WebServiceService,
	"dietcode.WebService",
) as unknown as {
	new (
