			...
			while (reader.pos < end) {
				...
				switch (tag >>> 3) {
					case 1: {
						...
						message.balance = UserCreditsBalance.decode(
							reader,
							reader.uint32(),
						);
						continue;
...
export const AccountServiceDefinition = {
	name: "AccountService",
	fullName: "dietcode.AccountService",
	methods: {
		/**
		...
		subscribeToAuthStatusUpdate: {
			...
			requestType: EmptyRequest as typeof EmptyRequest,
			requestStream: false,
			responseType: AuthState as typeof AuthState,
			responseStream: true,
			options: {},
		},
		/**
		...
		authStateChanged: {
			...
			requestType: AuthStateChangedRequest as typeof AuthStateChangedRequest,
			requestStream: false,
			responseType: AuthState as typeof AuthState,
			responseStream: false,
			options: {},
		...
		getUserCredits: {
			...
			requestType: EmptyRequest as typeof EmptyRequest,
			requestStream: false,
			responseType: UserCreditsData as typeof UserCreditsData,
			responseStream: false,
			options: {},
		},
		getOrganizationCredits: {
			...
			requestType:
				GetOrganizationCreditsRequest as typeof GetOrganizationCreditsRequest,
			requestStream: false,
			responseType: OrganizationCreditsData as typeof OrganizationCreditsData,
			responseStream: false,
			options: {},
		},
		/**
		...
		getUserOrganizations: {
			...
			requestStream: false,
			responseType:
				UserOrganizationsResponse as typeof UserOrganizationsResponse,
			responseStream: false,
			options: {},
		},
		setUserOrganization: {
			...
			requestType:
				UserOrganizationUpdateRequest as typeof UserOrganizationUpdateRequest,
			requestStream: false,
			responseType: Empty as typeof Empty,
			responseStream: false,
			options: {},
		...
		/** xAI Grok OAuth device-code authentication for SuperGrok / Premium+ subscriptions */
		xaiOauthSignIn: {
			name: "xaiOauthSignIn",
			requestType: EmptyRequest as typeof EmptyRequest,
			requestStream: false,
		...
		/** Signs out of xAI Grok and clears locally stored OAuth credentials */
		xaiOauthSignOut: {
			name: "xaiOauthSignOut",
			requestType: EmptyRequest as typeof EmptyRequest,
			requestStream: false,
			responseType: Empty as typeof Empty,
			responseStream: false,
		...
		/** Signs out of Google Personal and clears stored credentials */
		googleSignOutClicked: {
			name: "googleSignOutClicked",
			requestType: EmptyRequest as typeof EmptyRequest,
			requestStream: false,
			responseType: Empty as typeof Empty,
			responseStream: false,
...
export const AccountServiceService = {
	 ...
	 */
	accountLoginClicked: {
		path: "/dietcode.AccountService/accountLoginClicked" as const,
	 ...
	 */
	accountLogoutClicked: {
		path: "/dietcode.AccountService/accountLogoutClicked" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
	...
	/** Subscribe to auth status update events (when authentication state changes) */
	subscribeToAuthStatusUpdate: {
		path: "/dietcode.AccountService/subscribeToAuthStatusUpdate" as const,
		requestStream: false as const,
		...
		requestDeserialize: (value: Buffer): EmptyRequest =>
			EmptyRequest.decode(value),
		responseSerialize: (value: AuthState): Buffer =>
			Buffer.from(AuthState.encode(value).finish()),
	 ...
	 */
	authStateChanged: {
		path: "/dietcode.AccountService/authStateChanged" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: AuthStateChangedRequest): Buffer =>
			Buffer.from(AuthStateChangedRequest.encode(value).finish()),
		requestDeserialize: (value: Buffer): AuthStateChangedRequest =>
			AuthStateChangedRequest.decode(value),
		responseSerialize: (value: AuthState): Buffer =>
			Buffer.from(AuthState.encode(value).finish()),
		responseDeserialize: (value: Buffer): AuthState => AuthState.decode(value),
	},
	 ...
	 */
	getUserCredits: {
		path: "/dietcode.AccountService/getUserCredits" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
		requestDeserialize: (value: Buffer): EmptyRequest =>
			EmptyRequest.decode(value),
		responseSerialize: (value: UserCreditsData): Buffer =>
			Buffer.from(UserCreditsData.encode(value).finish()),
		responseDeserialize: (value: Buffer): UserCreditsData =>
			UserCreditsData.decode(value),
	},
	getOrganizationCredits: {
		path: "/dietcode.AccountService/getOrganizationCredits" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: GetOrganizationCreditsRequest): Buffer =>
			Buffer.from(GetOrganizationCreditsRequest.encode(value).finish()),
		requestDeserialize: (value: Buffer): GetOrganizationCreditsRequest =>
			GetOrganizationCreditsRequest.decode(value),
		responseSerialize: (value: OrganizationCreditsData): Buffer =>
			Buffer.from(OrganizationCreditsData.encode(value).finish()),
		responseDeserialize: (value: Buffer): OrganizationCreditsData =>
			OrganizationCreditsData.decode(value),
	},
	/**
	 * Fetches all user organizations data
	 * Returns a list of UserOrganization objects
	 */
	getUserOrganizations: {
		path: "/dietcode.AccountService/getUserOrganizations" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
		...
		responseDeserialize: (value: Buffer): UserOrganizationsResponse =>
			UserOrganizationsResponse.decode(value),
	},
	setUserOrganization: {
		path: "/dietcode.AccountService/setUserOrganization" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: UserOrganizationUpdateRequest): Buffer =>
			Buffer.from(UserOrganizationUpdateRequest.encode(value).finish()),
		requestDeserialize: (value: Buffer): UserOrganizationUpdateRequest =>
			UserOrganizationUpdateRequest.decode(value),
		responseSerialize: (value: Empty): Buffer =>
			Buffer.from(Empty.encode(value).finish()),
		responseDeserialize: (value: Buffer): Empty => Empty.decode(value),
	},
	...
	hicapAuthClicked: {
		path: "/dietcode.AccountService/hicapAuthClicked" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
	...
	googleAuthClicked: {
		path: "/dietcode.AccountService/googleAuthClicked" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
	...
	/** Returns a link the webview can use to redirect back to the user's IDE. */
	getRedirectUrl: {
		path: "/dietcode.AccountService/getRedirectUrl" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
	 ...
	 */
	openAiCodexSignIn: {
		path: "/dietcode.AccountService/openAiCodexSignIn" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
	...
	/** Signs out of OpenAI Codex and clears stored credentials */
	openAiCodexSignOut: {
		path: "/dietcode.AccountService/openAiCodexSignOut" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
	...
	/** xAI Grok OAuth device-code authentication for SuperGrok / Premium+ subscriptions */
	xaiOauthSignIn: {
		path: "/dietcode.AccountService/xaiOauthSignIn" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
	...
	/** Signs out of xAI Grok and clears locally stored OAuth credentials */
	xaiOauthSignOut: {
		path: "/dietcode.AccountService/xaiOauthSignOut" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
	...
	/** Signs out of Google Personal and clears stored credentials */
	googleSignOutClicked: {
		path: "/dietcode.AccountService/googleSignOutClicked" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
...
export interface AccountServiceServer extends UntypedServiceImplementation {
	...
	/** Subscribe to auth status update events (when authentication state changes) */
	subscribeToAuthStatusUpdate: handleServerStreamingCall<
		EmptyRequest,
		AuthState
	>;
	/**
	...
	getOrganizationCredits: handleUnaryCall<
		GetOrganizationCreditsRequest,
		OrganizationCreditsData
	>;
	/**
	 ...
	 * Returns a list of UserOrganization objects
	 */
	getUserOrganizations: handleUnaryCall<
		EmptyRequest,
		UserOrganizationsResponse
	>;
	...
	/** xAI Grok OAuth device-code authentication for SuperGrok / Premium+ subscriptions */
	xaiOauthSignIn: handleUnaryCall<EmptyRequest, Empty>;
	/** Signs out of xAI Grok and clears locally stored OAuth credentials */
	xaiOauthSignOut: handleUnaryCall<EmptyRequest, Empty>;
	/** Signs out of Google Personal and clears stored credentials */
	googleSignOutClicked: handleUnaryCall<EmptyRequest, Empty>;
}
...
export interface AccountServiceClient extends Client {
	...
	getOrganizationCredits(
		...
		callback: (
			...
			response: OrganizationCreditsData,
		) => void,
	): ClientUnaryCall;
	getOrganizationCredits(
		request: GetOrganizationCreditsRequest,
