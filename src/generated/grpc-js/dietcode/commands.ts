...
export const CommandContext: MessageFns<CommandContext> = {
				...
				switch (tag >>> 3) {
					...
					case 4: {
						...
						message.diagnostics.push(
							Diagnostic.decode(reader, reader.uint32()),
						);
						continue;
					}
				}
	...
	create<I extends Exact<DeepPartial<CommandContext>, I>>(
		base?: I,
	): CommandContext {
		return CommandContext.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<CommandContext>, I>>(
		object: I,
	): CommandContext {
		const message = createBaseCommandContext();
...
export const CommandsServiceService = {
	addToDietCode: {
		path: "/dietcode.CommandsService/addToDietCode" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: CommandContext): Buffer =>
			Buffer.from(CommandContext.encode(value).finish()),
		requestDeserialize: (value: Buffer): CommandContext =>
			CommandContext.decode(value),
		responseSerialize: (value: Empty): Buffer =>
			Buffer.from(Empty.encode(value).finish()),
		responseDeserialize: (value: Buffer): Empty => Empty.decode(value),
	},
	fixWithDietCode: {
		path: "/dietcode.CommandsService/fixWithDietCode" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: CommandContext): Buffer =>
			Buffer.from(CommandContext.encode(value).finish()),
	...
	explainWithDietCode: {
		path: "/dietcode.CommandsService/explainWithDietCode" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: CommandContext): Buffer =>
			Buffer.from(CommandContext.encode(value).finish()),
	...
	improveWithDietCode: {
		path: "/dietcode.CommandsService/improveWithDietCode" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: CommandContext): Buffer =>
			Buffer.from(CommandContext.encode(value).finish()),
...
export interface CommandsServiceServer extends UntypedServiceImplementation {
	addToDietCode: handleUnaryCall<CommandContext, Empty>;
	fixWithDietCode: handleUnaryCall<CommandContext, Empty>;
	explainWithDietCode: handleUnaryCall<CommandContext, Empty>;
	improveWithDietCode: handleUnaryCall<CommandContext, Empty>;
}
