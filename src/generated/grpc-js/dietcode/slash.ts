...
export const SlashServiceDefinition = {
  name: "SlashService",
  fullName: "dietcode.SlashService",
  methods: {
    ...
    getAvailableSlashCommands: {
      ...
      requestStream: false,
      responseType: SlashCommandsResponse as typeof SlashCommandsResponse,
      responseStream: false,
      options: {},
    },
  },
...
export const SlashServiceService = {
  /** Sends button click message */
  reportBug: {
    path: "/dietcode.SlashService/reportBug" as const,
  ...
  condense: {
    path: "/dietcode.SlashService/condense" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: StringRequest): Buffer => Buffer.from(StringRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): StringRequest => StringRequest.decode(value),
  ...
  /** Get available slash commands for autocomplete (used by CLI) */
  getAvailableSlashCommands: {
    path: "/dietcode.SlashService/getAvailableSlashCommands" as const,
    requestStream: false as const,
    responseStream: false as const,
