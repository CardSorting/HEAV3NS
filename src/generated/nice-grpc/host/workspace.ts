...
import { FileDiagnostics, Metadata } from "../dietcode/common";
...
export const GetWorkspacePathsRequest: MessageFns<GetWorkspacePathsRequest> = {
	...
	create(
		base?: DeepPartial<GetWorkspacePathsRequest>,
	): GetWorkspacePathsRequest {
		return GetWorkspacePathsRequest.fromPartial(base ?? {});
	},
	fromPartial(
		object: DeepPartial<GetWorkspacePathsRequest>,
	): GetWorkspacePathsRequest {
		const message = createBaseGetWorkspacePathsRequest();
...
export const GetWorkspacePathsResponse: MessageFns<GetWorkspacePathsResponse> =
	{
		...
		create(
			base?: DeepPartial<GetWorkspacePathsResponse>,
		): GetWorkspacePathsResponse {
			return GetWorkspacePathsResponse.fromPartial(base ?? {});
		},
		fromPartial(
			object: DeepPartial<GetWorkspacePathsResponse>,
		): GetWorkspacePathsResponse {
			const message = createBaseGetWorkspacePathsResponse();
			message.id = object.id ?? undefined;
...
export const SaveOpenDocumentIfDirtyRequest: MessageFns<SaveOpenDocumentIfDirtyRequest> =
	{
		...
		create(
			base?: DeepPartial<SaveOpenDocumentIfDirtyRequest>,
		): SaveOpenDocumentIfDirtyRequest {
			return SaveOpenDocumentIfDirtyRequest.fromPartial(base ?? {});
		},
		fromPartial(
			object: DeepPartial<SaveOpenDocumentIfDirtyRequest>,
		): SaveOpenDocumentIfDirtyRequest {
			const message = createBaseSaveOpenDocumentIfDirtyRequest();
...
export const SaveOpenDocumentIfDirtyResponse: MessageFns<SaveOpenDocumentIfDirtyResponse> =
	{
		...
		create(
			base?: DeepPartial<SaveOpenDocumentIfDirtyResponse>,
		): SaveOpenDocumentIfDirtyResponse {
			return SaveOpenDocumentIfDirtyResponse.fromPartial(base ?? {});
		},
		fromPartial(
			object: DeepPartial<SaveOpenDocumentIfDirtyResponse>,
		): SaveOpenDocumentIfDirtyResponse {
			const message = createBaseSaveOpenDocumentIfDirtyResponse();
...
export const GetDiagnosticsRequest: MessageFns<GetDiagnosticsRequest> = {
	...
	fromPartial(
		object: DeepPartial<GetDiagnosticsRequest>,
	): GetDiagnosticsRequest {
		const message = createBaseGetDiagnosticsRequest();
		message.metadata =
...
export const GetDiagnosticsResponse: MessageFns<GetDiagnosticsResponse> = {
	...
	fromPartial(
		object: DeepPartial<GetDiagnosticsResponse>,
	): GetDiagnosticsResponse {
		const message = createBaseGetDiagnosticsResponse();
...
export const SearchWorkspaceItemsRequest: MessageFns<SearchWorkspaceItemsRequest> =
	{
		...
		create(
			base?: DeepPartial<SearchWorkspaceItemsRequest>,
		): SearchWorkspaceItemsRequest {
			return SearchWorkspaceItemsRequest.fromPartial(base ?? {});
		},
		fromPartial(
			object: DeepPartial<SearchWorkspaceItemsRequest>,
		): SearchWorkspaceItemsRequest {
			const message = createBaseSearchWorkspaceItemsRequest();
...
export const SearchWorkspaceItemsResponse: MessageFns<SearchWorkspaceItemsResponse> =
	{
		...
		create(
			base?: DeepPartial<SearchWorkspaceItemsResponse>,
		): SearchWorkspaceItemsResponse {
			return SearchWorkspaceItemsResponse.fromPartial(base ?? {});
		},
		fromPartial(
			object: DeepPartial<SearchWorkspaceItemsResponse>,
		): SearchWorkspaceItemsResponse {
			const message = createBaseSearchWorkspaceItemsResponse();
			message.items =
				object.items?.map((e) =>
...
export const SearchWorkspaceItemsResponse_SearchItem: MessageFns<SearchWorkspaceItemsResponse_SearchItem> =
	{
		...
		create(
			base?: DeepPartial<SearchWorkspaceItemsResponse_SearchItem>,
		): SearchWorkspaceItemsResponse_SearchItem {
			return SearchWorkspaceItemsResponse_SearchItem.fromPartial(base ?? {});
		},
		fromPartial(
			object: DeepPartial<SearchWorkspaceItemsResponse_SearchItem>,
		): SearchWorkspaceItemsResponse_SearchItem {
			const message = createBaseSearchWorkspaceItemsResponse_SearchItem();
...
export const OpenProblemsPanelRequest: MessageFns<OpenProblemsPanelRequest> = {
	...
	create(
		base?: DeepPartial<OpenProblemsPanelRequest>,
	): OpenProblemsPanelRequest {
		return OpenProblemsPanelRequest.fromPartial(base ?? {});
	},
	fromPartial(
		_: DeepPartial<OpenProblemsPanelRequest>,
	): OpenProblemsPanelRequest {
		const message = createBaseOpenProblemsPanelRequest();
		return message;
	},
...
export const OpenProblemsPanelResponse: MessageFns<OpenProblemsPanelResponse> =
	{
		...
		create(
			base?: DeepPartial<OpenProblemsPanelResponse>,
		): OpenProblemsPanelResponse {
			return OpenProblemsPanelResponse.fromPartial(base ?? {});
		},
		fromPartial(
			_: DeepPartial<OpenProblemsPanelResponse>,
		): OpenProblemsPanelResponse {
			const message = createBaseOpenProblemsPanelResponse();
			return message;
		},
...
export const OpenInFileExplorerPanelRequest: MessageFns<OpenInFileExplorerPanelRequest> =
	{
		...
		create(
			base?: DeepPartial<OpenInFileExplorerPanelRequest>,
		): OpenInFileExplorerPanelRequest {
			return OpenInFileExplorerPanelRequest.fromPartial(base ?? {});
		},
		fromPartial(
			object: DeepPartial<OpenInFileExplorerPanelRequest>,
		): OpenInFileExplorerPanelRequest {
			const message = createBaseOpenInFileExplorerPanelRequest();
			message.path = object.path ?? "";
			return message;
...
export const OpenInFileExplorerPanelResponse: MessageFns<OpenInFileExplorerPanelResponse> =
	{
		...
		create(
			base?: DeepPartial<OpenInFileExplorerPanelResponse>,
		): OpenInFileExplorerPanelResponse {
			return OpenInFileExplorerPanelResponse.fromPartial(base ?? {});
		},
		fromPartial(
			_: DeepPartial<OpenInFileExplorerPanelResponse>,
		): OpenInFileExplorerPanelResponse {
			const message = createBaseOpenInFileExplorerPanelResponse();
			return message;
		},
...
export const OpenDietCodeSidebarPanelRequest: MessageFns<OpenDietCodeSidebarPanelRequest> =
	{
		...
		decode(
			input: BinaryReader | Uint8Array,
			length?: number,
		): OpenDietCodeSidebarPanelRequest {
			const reader =
				input instanceof BinaryReader ? input : new BinaryReader(input);
			const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
			if (previousRecursionDepth >= 100) {
		...
		create(
			base?: DeepPartial<OpenDietCodeSidebarPanelRequest>,
		): OpenDietCodeSidebarPanelRequest {
			return OpenDietCodeSidebarPanelRequest.fromPartial(base ?? {});
		},
		fromPartial(
			_: DeepPartial<OpenDietCodeSidebarPanelRequest>,
		): OpenDietCodeSidebarPanelRequest {
			const message = createBaseOpenDietCodeSidebarPanelRequest();
			return message;
		},
...
export const OpenDietCodeSidebarPanelResponse: MessageFns<OpenDietCodeSidebarPanelResponse> =
	{
		encode(
			_: OpenDietCodeSidebarPanelResponse,
			writer: BinaryWriter = new BinaryWriter(),
		): BinaryWriter {
			return writer;
		},
		...
		create(
			base?: DeepPartial<OpenDietCodeSidebarPanelResponse>,
		): OpenDietCodeSidebarPanelResponse {
			return OpenDietCodeSidebarPanelResponse.fromPartial(base ?? {});
		},
		fromPartial(
			_: DeepPartial<OpenDietCodeSidebarPanelResponse>,
		): OpenDietCodeSidebarPanelResponse {
			const message = createBaseOpenDietCodeSidebarPanelResponse();
			return message;
		},
...
export const ExecuteCommandInTerminalRequest: MessageFns<ExecuteCommandInTerminalRequest> =
	{
		...
		create(
			base?: DeepPartial<ExecuteCommandInTerminalRequest>,
		): ExecuteCommandInTerminalRequest {
			return ExecuteCommandInTerminalRequest.fromPartial(base ?? {});
		},
		fromPartial(
			object: DeepPartial<ExecuteCommandInTerminalRequest>,
		): ExecuteCommandInTerminalRequest {
			const message = createBaseExecuteCommandInTerminalRequest();
...
export const ExecuteCommandInTerminalResponse: MessageFns<ExecuteCommandInTerminalResponse> =
	{
		...
		create(
			base?: DeepPartial<ExecuteCommandInTerminalResponse>,
		): ExecuteCommandInTerminalResponse {
			return ExecuteCommandInTerminalResponse.fromPartial(base ?? {});
		},
		fromPartial(
			object: DeepPartial<ExecuteCommandInTerminalResponse>,
		): ExecuteCommandInTerminalResponse {
			const message = createBaseExecuteCommandInTerminalResponse();
...
export const WorkspaceServiceDefinition = {
	...
	methods: {
		...
		getWorkspacePaths: {
			...
			requestStream: false,
			responseType:
				GetWorkspacePathsResponse as typeof GetWorkspacePathsResponse,
		...
		saveOpenDocumentIfDirty: {
			...
			requestType:
				SaveOpenDocumentIfDirtyRequest as typeof SaveOpenDocumentIfDirtyRequest,
			requestStream: false,
			responseType:
				SaveOpenDocumentIfDirtyResponse as typeof SaveOpenDocumentIfDirtyResponse,
			responseStream: false,
			options: {},
		},
		...
		openProblemsPanel: {
			...
			requestStream: false,
			responseType:
				OpenProblemsPanelResponse as typeof OpenProblemsPanelResponse,
			responseStream: false,
			options: {},
		},
		...
		openInFileExplorerPanel: {
			...
			requestType:
				OpenInFileExplorerPanelRequest as typeof OpenInFileExplorerPanelRequest,
			requestStream: false,
			responseType:
				OpenInFileExplorerPanelResponse as typeof OpenInFileExplorerPanelResponse,
			responseStream: false,
			options: {},
		},
		...
		openDietCodeSidebarPanel: {
			...
			requestType:
				OpenDietCodeSidebarPanelRequest as typeof OpenDietCodeSidebarPanelRequest,
			requestStream: false,
			responseType:
				OpenDietCodeSidebarPanelResponse as typeof OpenDietCodeSidebarPanelResponse,
			responseStream: false,
			options: {},
		},
		...
		executeCommandInTerminal: {
			...
			requestType:
				ExecuteCommandInTerminalRequest as typeof ExecuteCommandInTerminalRequest,
			requestStream: false,
			responseType:
				ExecuteCommandInTerminalResponse as typeof ExecuteCommandInTerminalResponse,
			responseStream: false,
			options: {},
		},
...
export interface WorkspaceServiceImplementation<CallContextExt = {}> {
	...
	openDietCodeSidebarPanel(
		...
		context: CallContext & CallContextExt,
	): Promise<DeepPartial<OpenDietCodeSidebarPanelResponse>>;
	/** Opens and focuses the terminal panel. */
	openTerminalPanel(
...
export interface WorkspaceServiceClient<CallOptionsExt = {}> {
	...
	/** Opens and focuses the DietCode sidebar panel in the host IDE. */
	openDietCodeSidebarPanel(
		request: DeepPartial<OpenDietCodeSidebarPanelRequest>,
		options?: CallOptions & CallOptionsExt,
