...
export interface EnvServiceImplementation<CallContextExt = {}> {
  ...
  /** Logs a debug message to the host environment's log/output console. */
  debugLog(request: StringRequest, context: CallContext & CallContextExt): Promise<DeepPartial<Empty>>;
  /**
   * Opens an external URL in the default browser.
   * In remote environments (VS Code Server, SSH, etc.), this routes the URL
   * to the user's local machine to open in their local browser.
   */
  openExternal(request: StringRequest, context: CallContext & CallContextExt): Promise<DeepPartial<Empty>>;
}
...
export interface EnvServiceClient<CallOptionsExt = {}> {
  ...
  /** Logs a debug message to the host environment's log/output console. */
  debugLog(request: DeepPartial<StringRequest>, options?: CallOptions & CallOptionsExt): Promise<Empty>;
  /**
   * Opens an external URL in the default browser.
   * In remote environments (VS Code Server, SSH, etc.), this routes the URL
   * to the user's local machine to open in their local browser.
   */
  openExternal(request: DeepPartial<StringRequest>, options?: CallOptions & CallOptionsExt): Promise<Empty>;
}
