...
export const Settings_OpenAiHeadersEntry: MessageFns<Settings_OpenAiHeadersEntry> = {
  ...
  create(base?: DeepPartial<Settings_OpenAiHeadersEntry>): Settings_OpenAiHeadersEntry {
    return Settings_OpenAiHeadersEntry.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<Settings_OpenAiHeadersEntry>): Settings_OpenAiHeadersEntry {
    const message = createBaseSettings_OpenAiHeadersEntry();
...
export interface StateServiceImplementation<CallContextExt = {}> {
  ...
  refreshRemoteConfig(request: EmptyRequest, context: CallContext & CallContextExt): Promise<DeepPartial<Empty>>;
  testOtelConnection(
    request: EmptyRequest,
    context: CallContext & CallContextExt,
...
export interface StateServiceClient<CallOptionsExt = {}> {
  ...
  refreshRemoteConfig(request: DeepPartial<EmptyRequest>, options?: CallOptions & CallOptionsExt): Promise<Empty>;
  testOtelConnection(
    request: DeepPartial<EmptyRequest>,
    options?: CallOptions & CallOptionsExt,
