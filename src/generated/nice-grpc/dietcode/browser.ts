...
export const BrowserConnectionInfo: MessageFns<BrowserConnectionInfo> = {
	...
	fromPartial(
		object: DeepPartial<BrowserConnectionInfo>,
	): BrowserConnectionInfo {
		const message = createBaseBrowserConnectionInfo();
...
export const UpdateBrowserSettingsRequest: MessageFns<UpdateBrowserSettingsRequest> =
	{
		...
		create(
			base?: DeepPartial<UpdateBrowserSettingsRequest>,
		): UpdateBrowserSettingsRequest {
			return UpdateBrowserSettingsRequest.fromPartial(base ?? {});
		},
		fromPartial(
			object: DeepPartial<UpdateBrowserSettingsRequest>,
		): UpdateBrowserSettingsRequest {
			const message = createBaseUpdateBrowserSettingsRequest();
			message.metadata =
...
export interface BrowserServiceImplementation<CallContextExt = {}> {
	...
	getDetectedChromePath(
		request: EmptyRequest,
		context: CallContext & CallContextExt,
	): Promise<DeepPartial<ChromePath>>;
	relaunchChromeDebugMode(
		request: EmptyRequest,
		context: CallContext & CallContextExt,
