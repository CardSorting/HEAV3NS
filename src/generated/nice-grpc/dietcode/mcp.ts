...
export const ToggleMcpServerRequest: MessageFns<ToggleMcpServerRequest> = {
	...
	fromPartial(
		object: DeepPartial<ToggleMcpServerRequest>,
	): ToggleMcpServerRequest {
		const message = createBaseToggleMcpServerRequest();
		message.metadata =
...
export const UpdateMcpTimeoutRequest: MessageFns<UpdateMcpTimeoutRequest> = {
	...
	fromPartial(
		object: DeepPartial<UpdateMcpTimeoutRequest>,
	): UpdateMcpTimeoutRequest {
		const message = createBaseUpdateMcpTimeoutRequest();
		message.metadata =
			object.metadata !== undefined && object.metadata !== null
...
export const AddRemoteMcpServerRequest: MessageFns<AddRemoteMcpServerRequest> =
	{
		...
		create(
			base?: DeepPartial<AddRemoteMcpServerRequest>,
		): AddRemoteMcpServerRequest {
			return AddRemoteMcpServerRequest.fromPartial(base ?? {});
		},
		fromPartial(
			object: DeepPartial<AddRemoteMcpServerRequest>,
		): AddRemoteMcpServerRequest {
			const message = createBaseAddRemoteMcpServerRequest();
			message.metadata =
				object.metadata !== undefined && object.metadata !== null
...
export const ToggleToolAutoApproveRequest: MessageFns<ToggleToolAutoApproveRequest> =
	{
		...
		create(
			base?: DeepPartial<ToggleToolAutoApproveRequest>,
		): ToggleToolAutoApproveRequest {
			return ToggleToolAutoApproveRequest.fromPartial(base ?? {});
		},
		fromPartial(
			object: DeepPartial<ToggleToolAutoApproveRequest>,
		): ToggleToolAutoApproveRequest {
			const message = createBaseToggleToolAutoApproveRequest();
			message.metadata =
				object.metadata !== undefined && object.metadata !== null
...
export const McpMarketplaceCatalog: MessageFns<McpMarketplaceCatalog> = {
	...
	fromPartial(
		object: DeepPartial<McpMarketplaceCatalog>,
	): McpMarketplaceCatalog {
		const message = createBaseMcpMarketplaceCatalog();
		message.items =
...
export interface McpServiceImplementation<CallContextExt = {}> {
	...
	downloadMcp(
		...
		context: CallContext & CallContextExt,
	): Promise<DeepPartial<McpDownloadResponse>>;
	restartMcpServer(
		request: StringRequest,
		context: CallContext & CallContextExt,
	): Promise<DeepPartial<McpServers>>;
