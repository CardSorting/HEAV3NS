...
//   protoc               v5.29.3
// source: dietcode/commands.proto
...
export const CommandsServiceDefinition = {
  ...
  fullName: "dietcode.CommandsService",
  methods: {
    addToDietCode: {
      name: "addToDietCode",
      requestType: CommandContext as typeof CommandContext,
      requestStream: false,
...
export interface CommandsServiceImplementation<CallContextExt = {}> {
  addToDietCode(request: CommandContext, context: CallContext & CallContextExt): Promise<DeepPartial<Empty>>;
  fixWithDietCode(request: CommandContext, context: CallContext & CallContextExt): Promise<DeepPartial<Empty>>;
  explainWithDietCode(request: CommandContext, context: CallContext & CallContextExt): Promise<DeepPartial<Empty>>;
  improveWithDietCode(request: CommandContext, context: CallContext & CallContextExt): Promise<DeepPartial<Empty>>;
}

export interface CommandsServiceClient<CallOptionsExt = {}> {
  addToDietCode(request: DeepPartial<CommandContext>, options?: CallOptions & CallOptionsExt): Promise<Empty>;
  fixWithDietCode(request: DeepPartial<CommandContext>, options?: CallOptions & CallOptionsExt): Promise<Empty>;
  explainWithDietCode(request: DeepPartial<CommandContext>, options?: CallOptions & CallOptionsExt): Promise<Empty>;
  improveWithDietCode(request: DeepPartial<CommandContext>, options?: CallOptions & CallOptionsExt): Promise<Empty>;
}
