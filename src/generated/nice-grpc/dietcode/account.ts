...
export interface AccountServiceImplementation<CallContextExt = {}> {
  ...
  /** xAI Grok OAuth device-code authentication for SuperGrok / Premium+ subscriptions */
  xaiOauthSignIn(request: EmptyRequest, context: CallContext & CallContextExt): Promise<DeepPartial<Empty>>;
  /** Signs out of xAI Grok and clears locally stored OAuth credentials */
  xaiOauthSignOut(request: EmptyRequest, context: CallContext & CallContextExt): Promise<DeepPartial<Empty>>;
  /** Signs out of Google Personal and clears stored credentials */
  googleSignOutClicked(request: EmptyRequest, context: CallContext & CallContextExt): Promise<DeepPartial<Empty>>;
}
...
export interface AccountServiceClient<CallOptionsExt = {}> {
  ...
  /** xAI Grok OAuth device-code authentication for SuperGrok / Premium+ subscriptions */
  xaiOauthSignIn(request: DeepPartial<EmptyRequest>, options?: CallOptions & CallOptionsExt): Promise<Empty>;
  /** Signs out of xAI Grok and clears locally stored OAuth credentials */
  xaiOauthSignOut(request: DeepPartial<EmptyRequest>, options?: CallOptions & CallOptionsExt): Promise<Empty>;
  /** Signs out of Google Personal and clears stored credentials */
  googleSignOutClicked(request: DeepPartial<EmptyRequest>, options?: CallOptions & CallOptionsExt): Promise<Empty>;
}
