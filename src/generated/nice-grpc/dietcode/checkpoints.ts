...
//   protoc               v5.29.3
// source: dietcode/checkpoints.proto
...
export const CheckpointRestoreRequest: MessageFns<CheckpointRestoreRequest> = {
	...
	create(
		base?: DeepPartial<CheckpointRestoreRequest>,
	): CheckpointRestoreRequest {
		return CheckpointRestoreRequest.fromPartial(base ?? {});
	},
	fromPartial(
		object: DeepPartial<CheckpointRestoreRequest>,
	): CheckpointRestoreRequest {
		const message = createBaseCheckpointRestoreRequest();
		message.metadata =
...
export const CheckpointSubscriptionRequest: MessageFns<CheckpointSubscriptionRequest> =
	{
		...
		create(
			base?: DeepPartial<CheckpointSubscriptionRequest>,
		): CheckpointSubscriptionRequest {
			return CheckpointSubscriptionRequest.fromPartial(base ?? {});
		},
		fromPartial(
			object: DeepPartial<CheckpointSubscriptionRequest>,
		): CheckpointSubscriptionRequest {
			const message = createBaseCheckpointSubscriptionRequest();
...
export const PathHashMap_PathHashEntry: MessageFns<PathHashMap_PathHashEntry> =
	{
		...
		create(
			base?: DeepPartial<PathHashMap_PathHashEntry>,
		): PathHashMap_PathHashEntry {
			return PathHashMap_PathHashEntry.fromPartial(base ?? {});
		},
		fromPartial(
			object: DeepPartial<PathHashMap_PathHashEntry>,
		): PathHashMap_PathHashEntry {
			const message = createBasePathHashMap_PathHashEntry();
...
export const CheckpointsServiceDefinition = {
	...
	fullName: "dietcode.CheckpointsService",
	methods: {
		checkpointDiff: {
			name: "checkpointDiff",
		...
		subscribeToCheckpoints: {
			...
			requestType:
				CheckpointSubscriptionRequest as typeof CheckpointSubscriptionRequest,
			requestStream: false,
			responseType: CheckpointEvent as typeof CheckpointEvent,
			responseStream: true,
			options: {},
		},
		getCwdHash: {
			...
			requestStream: false,
			responseType: PathHashMap as typeof PathHashMap,
			responseStream: false,
			options: {},
		},
	},
...
export interface CheckpointsServiceImplementation<CallContextExt = {}> {
	...
	getCwdHash(
		...
		context: CallContext & CallContextExt,
	): Promise<DeepPartial<PathHashMap>>;
}
