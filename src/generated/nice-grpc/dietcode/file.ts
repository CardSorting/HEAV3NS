...
export const ToggleDietCodeRuleRequest: MessageFns<ToggleDietCodeRuleRequest> =
	{
		...
		create(
			base?: DeepPartial<ToggleDietCodeRuleRequest>,
		): ToggleDietCodeRuleRequest {
			return ToggleDietCodeRuleRequest.fromPartial(base ?? {});
		},
		fromPartial(
			object: DeepPartial<ToggleDietCodeRuleRequest>,
		): ToggleDietCodeRuleRequest {
			const message = createBaseToggleDietCodeRuleRequest();
			message.metadata =
				object.metadata !== undefined && object.metadata !== null
...
export const DietCodeRulesToggles_TogglesEntry: MessageFns<DietCodeRulesToggles_TogglesEntry> =
	{
		...
		create(
			base?: DeepPartial<DietCodeRulesToggles_TogglesEntry>,
		): DietCodeRulesToggles_TogglesEntry {
			return DietCodeRulesToggles_TogglesEntry.fromPartial(base ?? {});
		},
		fromPartial(
			object: DeepPartial<DietCodeRulesToggles_TogglesEntry>,
		): DietCodeRulesToggles_TogglesEntry {
			const message = createBaseDietCodeRulesToggles_TogglesEntry();
