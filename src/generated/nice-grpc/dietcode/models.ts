...
export const DietCodeRecommendedModel: MessageFns<DietCodeRecommendedModel> = {
  ...
  create(base?: DeepPartial<DietCodeRecommendedModel>): DietCodeRecommendedModel {
    return DietCodeRecommendedModel.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<DietCodeRecommendedModel>): DietCodeRecommendedModel {
    const message = createBaseDietCodeRecommendedModel();
...
export const DietCodeRecommendedModelsResponse: MessageFns<DietCodeRecommendedModelsResponse> = {
  ...
  create(base?: DeepPartial<DietCodeRecommendedModelsResponse>): DietCodeRecommendedModelsResponse {
    return DietCodeRecommendedModelsResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<DietCodeRecommendedModelsResponse>): DietCodeRecommendedModelsResponse {
    const message = createBaseDietCodeRecommendedModelsResponse();
