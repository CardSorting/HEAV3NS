...
export interface EnvServiceClientInterface {
	...
	clipboardWriteText(request: proto.dietcode.StringRequest): Promise<proto.dietcode.Empty>;

	clipboardReadText(request: proto.dietcode.EmptyRequest): Promise<proto.dietcode.String>;

	getHostVersion(request: proto.dietcode.EmptyRequest): Promise<proto.host.GetHostVersionResponse>;

	getIdeRedirectUri(request: proto.dietcode.EmptyRequest): Promise<proto.dietcode.String>;

	getTelemetrySettings(request: proto.dietcode.EmptyRequest): Promise<proto.host.GetTelemetrySettingsResponse>;

	subscribeToTelemetrySettings(request: proto.dietcode.EmptyRequest, callbacks: StreamingCallbacks<proto.host.TelemetrySettingsEvent>): () => void;
	...
	openExternal(request: proto.dietcode.StringRequest): Promise<proto.dietcode.Empty>;
}
...
export interface WorkspaceServiceClientInterface {
	...
	openDietCodeSidebarPanel(request: proto.host.OpenDietCodeSidebarPanelRequest): Promise<proto.host.OpenDietCodeSidebarPanelResponse>;
